...
```js
{
    ...
    default: EventEmitter {
        ...
        env: <ref *30> {
            ...
            [get/set] GOROOT_1_22_X64: "/opt/hostedtoolcache/go/1.22.0/x64",
        ...
        release: <ref *44> {
            name: "node",
            lts: false,
            sourceUrl: "https://github.com/oven-sh/bun/releases/download/bun-v1.0.30/bun-linux-x64-baseline.zip",
            headersUrl: "",
            libUrl: ""
        },
        report: <ref *45> {
