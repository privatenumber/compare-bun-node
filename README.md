...
_Last updated on <!-- lastUpdated:start -->Jan 5, 2026 with Bun 1.3.6 Node.js v24.12.0<!-- lastUpdated:end -->._
...
DeprecationWarning: OutgoingMessage.prototype._headerNames is deprecated
 code: "DEP0066"
      ...
      at <anonymous> (/tmp/fs-fixture-1767572508712-1/inspect.mjs:97:29)
      at map (1:11)
      at inspect (/tmp/fs-fixture-1767572508712-1/inspect.mjs:81:43)
      at <anonymous> (/tmp/fs-fixture-1767572508712-1/inspect.mjs:101:8)
      at map (1:11)
      at inspect (/tmp/fs-fixture-1767572508712-1/inspect.mjs:81:43)
      at <anonymous> (/tmp/fs-fixture-1767572508712-1/inspect.mjs:101:8)
...
(node:2431) [DEP0125] DeprecationWarning: The _stream_wrap module is deprecated.
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1767572508712-1/module.mjs: "/tmp/fs-fixture-1767572508712-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            ...
            "/opt/hostedtoolcache/node/24.12.0/x64/lib/node"
        ],
...
<ref *1> [Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 1) {
        _cache: <ref *3> {
            ...
            /tmp/fs-fixture-1767572508712-1/module.mjs: {
                exports: [Object: null prototype] {}
            },
            node:module: {
                exports: [Circular: *1]
            },
            /tmp/fs-fixture-1767572508712-1/inspect.mjs: {
                exports: [Object: null prototype] {
...
[Object: null prototype] {
    ...
    default: {
        performance: <ref *14> {
            ...
            timeOrigin: 1767572509662.046,
            toJSON: ƒ toJSON(length: 1) {},
            onresourcetimingbufferfull: null,
            nodeTiming: PerformanceNodeTiming {
                v8Start: 1767572509662.046,
                nodeStart: 1767572509662.046,
                environment: 1767572509662.046,
                bootstrapComplete: 1767572509662.046,
                idleTime: 1,
                loopStart: 1,
                loopExit: -1
            },
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *26> [
        "/opt/hostedtoolcache/node/24.12.0/x64/bin/node",
        "/tmp/fs-fixture-1767572508712-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        env: <ref *120>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_d8c06b7e-1aee-4f82-9013-6abe82da5b54",
            npm_package_devDependencies__types_node: "^18.15.11",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            npm_config_user_agent: "pnpm/9.12.1 npm/? node/v24.12.0 linux x64",
            CI: "true",
            RUNNER_ENVIRONMENT: "github-hosted",
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_d8c06b7e-1aee-4f82-9013-6abe82da5b54",
            PIPX_HOME: "/opt/pipx",
            npm_node_execpath: "/opt/hostedtoolcache/node/24.12.0/x64/bin/node",
            ...
            GITHUB_RUN_ID: "20701431101",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "464a91df349b8049da5bc30acdd433276c0eae45",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_53714b95-2e6b-434b-b840-f5babc559d0e",
            INVOCATION_ID: "8d4174f0be09465ab87660cb6af37f0f",
            RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            NODE: "/opt/hostedtoolcache/node/24.12.0/x64/bin/node",
            GITHUB_ACTION: "__run",
            ...
            RUNNER_NAME: "GitHub Actions 1000005531",
            ...
            GITHUB_SHA: "464a91df349b8049da5bc30acdd433276c0eae45",
            ...
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_d8c06b7e-1aee-4f82-9013-6abe82da5b54",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_d8c06b7e-1aee-4f82-9013-6abe82da5b54",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_d8c06b7e-1aee-4f82-9013-6abe82da5b54",
        ...
        pid: 2952,
        ppid: 2271,
        execPath: "/opt/hostedtoolcache/node/24.12.0/x64/bin/node",
        debugPort: 9229,
        argv0: "node",
...
[Object: null prototype] {
    ...
    default: EventEmitter {
        ...
        release: <ref *49> {
            name: "node",
            sourceUrl: "https://github.com/oven-sh/bun/releases/download/bun-v1.3.6/bun-linux-x64-baseline.zip",
        ...
        revision: "27ff6aaae0e925659c8f82ab6a4be17ec9c35a4a",
        send: undefined,
        ...
        versions: <ref *239> {
            ...
            uwebsockets: "27ff6aaae0e925659c8f82ab6a4be17ec9c35a4a",
            ...
            usockets: "27ff6aaae0e925659c8f82ab6a4be17ec9c35a4a",
...
(node:2969) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
[Object: null prototype] {
    ...
    context: <ref *4> {
        ...
        Bun: {
            ...
            argv: <ref *106> [
                "/home/runner/.bun/bin/bun",
                "/tmp/fs-fixture-1767572508712-1/repl.mjs"
            ],
            ...
            [get/set] main: "/tmp/fs-fixture-1767572508712-1/repl.mjs",
            ...
            sql: <ref *188> ƒ sql(length: 1) {
                reserve: ƒ (length: 0) {},
                array: ƒ (length: 0) {},
                commitDistributed: ƒ (length: 0) {},
                rollbackDistributed: ƒ (length: 0) {},
                beginDistributed: <ref *193> ƒ (length: 0) {},
                distributed: [Circular: *193],
                connect: ƒ (length: 0) {},
                unsafe: ƒ (length: 0) {},
                file: ƒ (length: 1) {},
                begin: <ref *197> ƒ (length: 0) {},
                transaction: [Circular: *197],
                close: <ref *198> ƒ (length: 0) {},
                end: [Circular: *198],
                flush: ƒ (length: 0) {}
            },
            postgres: [Circular: *188],
            SQL: ƒ SQL2(length: 0) {
        ...
        process: EventEmitter {
            ...
            stderr: WriteStream {
                ...
                pos: undefined,
                bytesWritten: 0,
                _write: <ref *292> ƒ underscoreWriteFast(length: 3) {},
                write: <ref *293> ƒ writeFast(length: 3) {},
                _events: {
                    close: undefined,
                    error: undefined,
                    prefinish: undefined,
                ...
                readable: false,
                _type: "fs",
                destroySoon: <ref *300> ƒ (length: 2) {},
                _destroy: ƒ (length: 2) {},
                _isStdio: true,
                Symbol(kFs): <ref *302> {
                    appendFile: ƒ appendFile(length: 4) {},
                    ...
                    W_OK: 2,
                    X_OK: 1,
                    constants: <ref *398> [Object: null prototype] {
                        UV_FS_SYMLINK_DIR: 1,
                        UV_FS_SYMLINK_JUNCTION: 2,
                        O_RDONLY: 0,
                        O_WRONLY: 1,
                    ...
                    Dir: class Dir {},
                    Stats: ƒ Stats(length: 0) {},
                    [get/set] ReadStream: <ref *401> ƒ ReadStream(length: 2) {},
                    WriteStream: <ref *402> ƒ WriteStream(length: 2) {},
                    [get/set] FileReadStream: [Circular: *401],
                    [get/set] FileWriteStream: [Circular: *402],
                    promises: {
                        access: async ƒ access(length: 3) {},
                        appendFile: async ƒ appendFile(length: 1) {},
                        close: async ƒ close(length: 1) {},
            ...
            stdin: ReadStream {
                ...
                _maxListeners: undefined,
                _eventsCount: NaN,
                on: <ref *464> ƒ (length: 2) {},
                addListener: [Circular: *464],
                ref: ƒ (length: 0) {},
                unref: ƒ (length: 0) {},
                pause: ƒ (length: 0) {},
                resume: ƒ (length: 0) {},
                _read: ƒ triggerRead(length: 1) {},
                Symbol(kFs): [Circular: *302],
                Symbol(kReadStreamFastPath): false,
                Symbol(kCapture): false
            },
            stdout: WriteStream {
        ...
        BuildError: <ref *506> ƒ BuildMessage(length: 0) {},
        BuildMessage: [Circular: *506],
        Crypto: ƒ Crypto(length: 0) {},
        HTMLRewriter: ƒ HTMLRewriter(length: 0) {},
        Request: ƒ Request(length: 0) {},
        ResolveError: <ref *510> ƒ ResolveMessage(length: 0) {},
        ResolveMessage: [Circular: *510],
...
(node:3118) [DEP0025] DeprecationWarning: sys is deprecated. Use util instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
(node:3294) ExperimentalWarning: WASI is an experimental feature and might change at any time
...
error: Could not resolve: "node:sea". Maybe you need to "bun install"?
    at /tmp/fs-fixture-1767572508712-1/node:sea.mjs:2:25

Bun v1.3.6-canary.54+27ff6aaae (Linux x64 baseline)
```
...
(node:3358) ExperimentalWarning: SQLite is an experimental feature and might change at any time
(Use `node --trace-warnings ...` to show where the warning was created)
```
...
error: Could not resolve: "node:sqlite". Maybe you need to "bun install"?
    at /tmp/fs-fixture-1767572508712-1/node:sqlite.mjs:2:25
...
error: Could not resolve: "node:test/reporters". Maybe you need to "bun install"?
    at /tmp/fs-fixture-1767572508712-1/node:test_reporters.mjs:2:25
