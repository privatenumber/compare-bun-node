...
_Last updated on <!-- lastUpdated:start -->Mar 31, 2025 with Bun 1.2.8 Node.js v22.14.0<!-- lastUpdated:end -->._
...
```js
{
    ...
    WebSocket: <ref *83> ƒ WebSocket(length: 1) {
        CONNECTING: 0,
        OPEN: 1,
        CLOSING: 2,
        CLOSED: 3
    },
    createServer: <ref *84> ƒ createServer(length: 2) {},
    default: {
        Agent: [Circular: *2],
        Server: [Circular: *53],
        METHODS: [Circular: *23],
        STATUS_CODES: [Circular: *52],
        createServer: [Circular: *84],
        ServerResponse: [Circular: *65],
        IncomingMessage: [Circular: *6],
        request: <ref *86> ƒ request(length: 3) {},
        get: <ref *87> ƒ get(length: 3) {},
        [get/set] maxHeaderSize: 16384,
        validateHeaderName: <ref *88> ƒ validateHeaderName(length: 2) {},
        validateHeaderValue: <ref *89> ƒ validateHeaderValue(length: 2) {},
        setMaxIdleHTTPParsers: <ref *90> ƒ setMaxIdleHTTPParsers(length: 1) {},
        globalAgent: <ref *91> Agent {
            _events: [Object: null prototype] {},
            _eventsCount: 0,
            _maxListeners: undefined,
            defaultPort: 80,
        ...
        WebSocket: [Circular: *83],
        CloseEvent: [Circular: *5],
        MessageEvent: [Circular: *24]
    },
    get: [Circular: *87],
    globalAgent: [Circular: *91],
    maxHeaderSize: 16384,
    request: [Circular: *86],
    setMaxIdleHTTPParsers: [Circular: *90],
    validateHeaderName: [Circular: *88],
    validateHeaderValue: [Circular: *89]
}
```
...
(node:2217) [DEP0125] DeprecationWarning: The _stream_wrap module is deprecated.
...
```js
{
    ...
    KeyObject: <ref *15> class KeyObject {},
    ...
    createHash: <ref *26> ƒ createHash(length: 2) {},
    createHmac: <ref *27> ƒ createHmac(length: 3) {},
    createPrivateKey: <ref *28> ƒ _createPrivateKey(length: 1) {},
    createPublicKey: <ref *29> ƒ _createPublicKey(length: 1) {},
    createSecretKey: <ref *30> ƒ (length: 2) {},
    createSign: <ref *31> ƒ createSign(length: 2) {},
    createVerify: <ref *32> ƒ createVerify(length: 2) {},
    default: {
        getRandomValues: <ref *34> ƒ (length: 1) {},
        constants: [Circular: *21],
        generateKeySync: <ref *35> ƒ (length: 2) {},
        generateKey: <ref *36> ƒ (length: 3) {},
        generateKeyPairSync: <ref *37> ƒ _generateKeyPairSync(length: 2) {},
        generateKeyPair: <ref *38> ƒ _generateKeyPair(length: 3) {},
        createSecretKey: [Circular: *30],
        createPrivateKey: [Circular: *28],
        createPublicKey: [Circular: *29],
        KeyObject: [Circular: *15],
        publicEncrypt: <ref *39> ƒ (length: 2) {},
        privateDecrypt: <ref *40> ƒ (length: 2) {},
        privateEncrypt: <ref *41> ƒ (length: 2) {},
        publicDecrypt: <ref *42> ƒ (length: 2) {},
        hash: <ref *43> ƒ hash(length: 2) {},
        pbkdf2: <ref *44> ƒ pbkdf2(length: 6) {},
        pbkdf2Sync: <ref *45> ƒ pbkdf2Sync(length: 5) {},
        hkdf: <ref *46> ƒ hkdf(length: 6) {},
        hkdfSync: <ref *47> ƒ hkdfSync(length: 5) {},
        getCurves: <ref *48> ƒ getCurves(length: 0) {},
        getCipherInfo: <ref *49> ƒ getCipherInfo(length: 1) {},
        timingSafeEqual: <ref *50> ƒ timingSafeEqual(length: 2) {},
        webcrypto: <ref *51> Crypto {
            subtle: <ref *52> SubtleCrypto {}
        },
        subtle: [Circular: *52],
        X509Certificate: [Circular: *18],
        Certificate: [Circular: *2],
        Sign: [Circular: *16],
        sign: <ref *53> ƒ sign(length: 4) {},
        createSign: [Circular: *31],
        Verify: [Circular: *17],
        verify: <ref *54> ƒ verify(length: 4) {},
        createVerify: [Circular: *32],
        Hash: [Circular: *13],
        createHash: [Circular: *26],
        Hmac: [Circular: *14],
        createHmac: [Circular: *27],
        getHashes: <ref *55> ƒ getHashes(length: 0) {},
        randomInt: <ref *56> ƒ randomInt(length: 2) {},
        randomFill: <ref *57> ƒ randomFill(length: 4) {},
        randomFillSync: <ref *58> ƒ randomFillSync(length: 3) {},
        randomBytes: <ref *59> ƒ randomBytes(length: 2) {},
        randomUUID: <ref *60> ƒ randomUUID(length: 1) {},
        checkPrime: [Circular: *19],
        checkPrimeSync: [Circular: *20],
        generatePrime: <ref *61> ƒ generatePrime(length: 3) {},
        generatePrimeSync: <ref *62> ƒ generatePrimeSync(length: 2) {},
        ...
        diffieHellman: <ref *67> ƒ diffieHellman(length: 1) {},
        ECDH: [Circular: *11],
        createECDH: [Circular: *25],
        Cipheriv: [Circular: *7],
        ...
        getCiphers: <ref *68> ƒ getCiphers(length: 0) {},
        scrypt: <ref *69> ƒ scrypt(length: 5) {},
        scryptSync: <ref *70> ƒ scryptSync(length: 4) {}
    },
    diffieHellman: [Circular: *67],
    generateKey: [Circular: *36],
    generateKeyPair: [Circular: *38],
    generateKeyPairSync: [Circular: *37],
    generateKeySync: [Circular: *35],
    generatePrime: [Circular: *61],
    generatePrimeSync: [Circular: *62],
    getCipherInfo: [Circular: *49],
    getCiphers: [Circular: *68],
    getCurves: [Circular: *48],
    getDiffieHellman: [Circular: *10],
    getFips: [Circular: *65],
    getHashes: [Circular: *55],
    getRandomValues: [Circular: *34],
    hash: [Circular: *43],
    hkdf: [Circular: *46],
    hkdfSync: [Circular: *47],
    pbkdf2: [Circular: *44],
    pbkdf2Sync: [Circular: *45],
    privateDecrypt: [Circular: *40],
    privateEncrypt: [Circular: *41],
    publicDecrypt: [Circular: *42],
    publicEncrypt: [Circular: *39],
    randomBytes: [Circular: *59],
    randomFill: [Circular: *57],
    randomFillSync: [Circular: *58],
    randomInt: [Circular: *56],
    randomUUID: [Circular: *60],
    scrypt: [Circular: *69],
    scryptSync: [Circular: *70],
    secureHeapUsed: [Circular: *63],
    setEngine: [Circular: *64],
    setFips: [Circular: *66],
    sign: [Circular: *53],
    subtle: [Circular: *52],
    timingSafeEqual: [Circular: *50],
    verify: [Circular: *54],
    webcrypto: [Circular: *51]
}
```
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1743380274447-1/module.mjs: "/tmp/fs-fixture-1743380274447-1/module.mjs"
        },
...
<ref *1> {
    Module: <ref *2> ƒ Module(length: 1) {
        _cache: <ref *3> {
            ...
            /tmp/fs-fixture-1743380274447-1/module.mjs: {
                exports: {}
            },
            node:module: {
                exports: [Circular: *1]
            },
            /tmp/fs-fixture-1743380274447-1/inspect.mjs: {
                exports: {
        ...
        [get/set] runMain: <ref *35> ƒ runMain(length: 2) {},
...
```js
{
    ...
    default: {
        performance: <ref *13> {
            ...
            timeOrigin: 1743380275603.3967,
            toJSON: ƒ toJSON(length: 1) {},
            onresourcetimingbufferfull: null,
            nodeTiming: PerformanceNodeTiming {
                v8Start: 1743380275603.3967,
                nodeStart: 1743380275603.3967,
                environment: 1743380275603.3967,
                bootstrapComplete: 1743380275603.3967,
                idleTime: 1,
                loopStart: 1,
                loopExit: -1
            },
...
[Object: null prototype] {
    ...
    argv: <ref *26> [
        ...
        "/tmp/fs-fixture-1743380274447-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        env: <ref *118>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
            ...
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
            PIPX_HOME: "/opt/pipx",
            ...
            STATS_D: "true",
            GITHUB_RUN_ID: "14161407309",
            STATS_VMFE: "true",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "22103974089b53bcbe3ddda6bb7a6bb6347a3d44",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_aa26ee5d-92a1-4d73-8daa-76f22492b99c",
            INVOCATION_ID: "e9096eefb3b54132b6b0f3f3e7c8fe30",
            ...
            RUNNER_NAME: "GitHub-Actions-1000000429",
            ...
            GITHUB_SHA: "22103974089b53bcbe3ddda6bb7a6bb6347a3d44",
            ...
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
...
```js
{
    ...
    default: EventEmitter {
        ...
        env: <ref *31> {
            [get/set] GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
            ...
            [get/set] GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
            ...
            [get/set] ImageVersion: "20250323.1.0",
            ...
            [get/set] GITHUB_RUN_ID: "14161407309",
            [get/set] STATS_VMFE: "true",
            [get/set] GITHUB_REF_TYPE: "branch",
            [get/set] BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            [get/set] GITHUB_WORKFLOW_SHA: "22103974089b53bcbe3ddda6bb7a6bb6347a3d44",
            ...
            [get/set] RUNNER_TRACKING_ID: "github_aa26ee5d-92a1-4d73-8daa-76f22492b99c",
            [get/set] INVOCATION_ID: "e9096eefb3b54132b6b0f3f3e7c8fe30",
            ...
            [get/set] RUNNER_NAME: "GitHub-Actions-1000000429",
            ...
            [get/set] GITHUB_SHA: "22103974089b53bcbe3ddda6bb7a6bb6347a3d44",
            ...
            [get/set] GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
            ...
            [get/set] GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
            ...
            [get/set] GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_d981719b-0fe0-49bd-9b3e-1a3ffbcd6de9",
        ...
        release: <ref *46> {
            name: "node",
            sourceUrl: "https://github.com/oven-sh/bun/releases/download/bun-v1.2.8/bun-linux-x64-baseline.zip",
        ...
        revision: "fee911194a06554e4a9d0cb4dc5c57c1ca5db7dd",
        ...
        versions: <ref *232> {
            ...
            uwebsockets: "fee911194a06554e4a9d0cb4dc5c57c1ca5db7dd",
            webkit: "ef31d98a1370e01b7483cabcbe3593d055bea982",
            zig: "0.14.0",
            ...
            usockets: "fee911194a06554e4a9d0cb4dc5c57c1ca5db7dd",
        ...
        _kill: [Circular: *7],
        getBuiltinModule: <ref *233> ƒ getBuiltinModule(length: 1) {},
        getegid: <ref *234> ƒ getegid(length: 0) {},
        geteuid: <ref *235> ƒ geteuid(length: 0) {},
        getgid: <ref *236> ƒ getgid(length: 0) {},
        getgroups: <ref *237> ƒ getgroups(length: 0) {},
        getuid: <ref *238> ƒ getuid(length: 0) {},
        setegid: <ref *239> ƒ setegid(length: 1) {},
        seteuid: <ref *240> ƒ seteuid(length: 1) {},
        setgid: <ref *241> ƒ setgid(length: 1) {},
        setgroups: <ref *242> ƒ setgroups(length: 1) {},
        setuid: <ref *243> ƒ setuid(length: 1) {},
    ...
    getBuiltinModule: [Circular: *233],
    getMaxListeners: ƒ getMaxListeners(length: 0) {},
    getegid: [Circular: *234],
    geteuid: [Circular: *235],
    getgid: [Circular: *236],
    getgroups: [Circular: *237],
    getuid: [Circular: *238],
    ...
    setegid: [Circular: *239],
    seteuid: [Circular: *240],
    setgid: [Circular: *241],
    setgroups: [Circular: *242],
    setuid: [Circular: *243],
    stderr: [Circular: *52],
    stdin: [Circular: *207],
    stdout: [Circular: *224],
...
```js
{
    ...
    context: <ref *4> {
        ...
        Bun: {
            ...
            argv: [
                "/home/runner/.bun/bin/bun",
                "/tmp/fs-fixture-1743380274447-1/repl.mjs"
            ],
            ...
            main: "/tmp/fs-fixture-1743380274447-1/repl.mjs",
            ...
            sql: <ref *181> ƒ sql(length: 1) {
                reserve: ƒ (length: 0) {},
                commitDistributed: ƒ (length: 0) {},
                rollbackDistributed: ƒ (length: 0) {},
                beginDistributed: <ref *185> ƒ (length: 0) {},
                distributed: [Circular: *185],
                connect: ƒ (length: 0) {},
                unsafe: ƒ (length: 0) {},
                file: async ƒ (length: 0) {},
                begin: <ref *189> ƒ (length: 0) {},
                transaction: [Circular: *189],
                close: <ref *190> ƒ (length: 0) {},
                end: [Circular: *190],
                flush: ƒ (length: 0) {}
            },
            postgres: [Circular: *181],
            SQL: ƒ SQL(length: 1) {},
        ...
        process: EventEmitter {
            ...
            stderr: WriteStream {
                ...
                pos: undefined,
                bytesWritten: 0,
                _write: <ref *253> ƒ underscoreWriteFast(length: 3) {},
                write: <ref *254> ƒ writeFast(length: 3) {},
                _events: {
                    close: undefined,
                    error: undefined,
                    prefinish: undefined,
                ...
                readable: false,
                _type: "fs",
                destroySoon: <ref *261> ƒ (length: 2) {},
                _destroy: ƒ (length: 2) {},
                _isStdio: true,
                Symbol(kFs): <ref *263> {
                    appendFile: ƒ appendFile(length: 4) {},
                    ...
                    W_OK: 2,
                    X_OK: 1,
                    constants: <ref *359> [Object: null prototype] {
                        UV_FS_SYMLINK_DIR: 1,
                        UV_FS_SYMLINK_JUNCTION: 2,
                        O_RDONLY: 0,
                        O_WRONLY: 1,
            ...
            stdin: ReadStream {
                ...
                _maxListeners: undefined,
                _eventsCount: NaN,
                on: <ref *424> ƒ (length: 2) {},
                addListener: [Circular: *424],
                ref: ƒ (length: 0) {},
                unref: ƒ (length: 0) {},
                pause: ƒ (length: 0) {},
                resume: ƒ (length: 0) {},
                _read: ƒ triggerRead(length: 1) {},
                Symbol(kFs): [Circular: *263],
                Symbol(kReadStreamFastPath): false,
                Symbol(kCapture): false
            },
            stdout: WriteStream {
        ...
        BuildError: <ref *477> ƒ BuildMessage(length: 0) {},
        BuildMessage: [Circular: *477],
        Crypto: ƒ Crypto(length: 0) {},
        HTMLRewriter: ƒ HTMLRewriter(length: 0) {},
        Request: ƒ Request(length: 0) {},
        ResolveError: <ref *481> ƒ ResolveMessage(length: 0) {},
        ResolveMessage: [Circular: *481],
...
(node:3119) [DEP0025] DeprecationWarning: sys is deprecated. Use util instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
