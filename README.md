...
_Last updated on <!-- lastUpdated:start -->Dec 30, 2024 with Bun 1.1.42 Node.js v22.12.0<!-- lastUpdated:end -->._
...
```js
{
    ...
    EventEmitter: <ref *13> ƒ EventEmitter(length: 1) {
        ...
        EventEmitterAsyncResource: <ref *33> class EventEmitterAsyncResource extends EventEmitter {},
...
```js
{
    ...
    KeyObject: <ref *11> class KeyObject {},
    ...
    createHash: <ref *17> ƒ createHash(length: 2) {
    ...
    default: {
        ...
        getRandomValues: <ref *27> ƒ getRandomValues(length: 1) {},
        ...
        hash: <ref *40> ƒ hash(length: 2) {},
        getFips: <ref *41> ƒ getFips(length: 0) {},
        randomUUID: <ref *42> ƒ randomUUID(length: 0) {},
        randomInt: <ref *43> ƒ randomInt(length: 3) {},
        getCurves: <ref *44> ƒ getCurves(length: 0) {},
        scrypt: <ref *45> ƒ ::bunternal::(length: 5) {},
        scryptSync: <ref *46> ƒ ::bunternal::(length: 4) {},
        timingSafeEqual: <ref *47> ƒ ::bunternal::(length: 2) {},
        webcrypto: <ref *48> Crypto {
            subtle: <ref *49> SubtleCrypto {}
        },
        subtle: [Circular: *49]
    },
    ...
    randomInt: [Circular: *43],
    randomUUID: [Circular: *42],
    rng: [Circular: *22],
    scrypt: [Circular: *45],
    scryptSync: [Circular: *46],
    sign: [Circular: *34],
    subtle: [Circular: *49],
    timingSafeEqual: [Circular: *47],
    verify: [Circular: *35],
    webcrypto: [Circular: *48]
}
```
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1735517791220-1/module.mjs: "/tmp/fs-fixture-1735517791220-1/module.mjs"
        },
...
<ref *1> {
    Module: <ref *2> ƒ Module(length: 1) {
        _cache: <ref *3> {
            ...
            /tmp/fs-fixture-1735517791220-1/module.mjs: {
                exports: {}
            },
            module: {
                exports: [Circular: *1]
            },
            /tmp/fs-fixture-1735517791220-1/inspect.mjs: {
                exports: {
...
```js
{
    ...
    default: {
        performance: <ref *14> {
            ...
            timeOrigin: 1735517792243.6255,
            toJSON: ƒ toJSON(length: 1) {},
            onresourcetimingbufferfull: null,
            nodeTiming: PerformanceNodeTiming {
                v8Start: 1735517792243.6255,
                nodeStart: 1735517792243.6255,
                environment: 1735517792243.6255,
                bootstrapComplete: 1735517792243.6255,
                idleTime: 1,
                loopStart: 1,
                loopExit: -1
            },
...
[Object: null prototype] {
    ...
    argv: <ref *26> [
        ...
        "/tmp/fs-fixture-1735517791220-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        env: <ref *116>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
            ...
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
            PIPX_HOME: "/opt/pipx",
            ...
            STATS_D: "false",
            GITHUB_RUN_ID: "12539858846",
            STATS_VMFE: "true",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "eb6c03a8722cc09ca6509636f8268e15328f6c48",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_09c0ac97-a3f3-4736-a3e6-bf4a0c13e001",
            INVOCATION_ID: "c35844ab1e5d4f799897954a569d85e9",
            ...
            GITHUB_SHA: "eb6c03a8722cc09ca6509636f8268e15328f6c48",
            ...
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
...
```js
{
    ...
    default: EventEmitter {
        ...
        env: <ref *30> {
            [get/set] GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
            ...
            [get/set] GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
            ...
            [get/set] GITHUB_RUN_ID: "12539858846",
            [get/set] STATS_VMFE: "true",
            [get/set] GITHUB_REF_TYPE: "branch",
            [get/set] BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            [get/set] GITHUB_WORKFLOW_SHA: "eb6c03a8722cc09ca6509636f8268e15328f6c48",
            ...
            [get/set] RUNNER_TRACKING_ID: "github_09c0ac97-a3f3-4736-a3e6-bf4a0c13e001",
            [get/set] INVOCATION_ID: "c35844ab1e5d4f799897954a569d85e9",
            ...
            [get/set] RUNNER_NAME: "GitHub Actions 4",
            ...
            [get/set] GITHUB_SHA: "eb6c03a8722cc09ca6509636f8268e15328f6c48",
            ...
            [get/set] GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
            ...
            [get/set] GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
            ...
            [get/set] GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_711a620e-84a2-4ff1-ac0e-47a36a3d92a8",
        ...
        release: <ref *45> {
            name: "node",
            lts: false,
            sourceUrl: "https://github.com/oven-sh/bun/releases/download/bun-v1.1.42/bun-linux-x64-baseline.zip",
            headersUrl: "",
            libUrl: ""
        },
        report: <ref *46> {
        ...
        revision: "18ac7f9509b16c3b1f8e98cebd18a6474c97bed7",
        ...
        versions: <ref *96> {
            ...
            uwebsockets: "18ac7f9509b16c3b1f8e98cebd18a6474c97bed7",
            webkit: "00e2b186fd25e79cea4cb4d63d9fd388192327f6",
            zig: "0.13.0",
            ...
            usockets: "18ac7f9509b16c3b1f8e98cebd18a6474c97bed7",
...
(node:2903) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
```js
{
    ...
    context: <ref *4> {
        ...
        Bun: {
            ...
            argv: [
                "/home/runner/.bun/bin/bun",
                "/tmp/fs-fixture-1735517791220-1/repl.mjs"
            ],
        ...
        navigator: {
            userAgent: "Bun/1.1.42",
            platform: "Linux x86_64",
            hardwareConcurrency: 4
        },
        performance: Performance {
            now: ƒ now(length: 0) {},
            timeOrigin: 1735517792344.251
        },
...
(node:3095) [DEP0025] DeprecationWarning: sys is deprecated. Use util instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
```js
{
    ...
    default: {
        ...
        isArray: <ref *105> ƒ isArray(length: 1) {},
        isBoolean: <ref *106> ƒ isBoolean(length: 1) {},
        isNull: <ref *107> ƒ isNull(length: 1) {},
        isNullOrUndefined: <ref *108> ƒ isNullOrUndefined(length: 1) {},
        isNumber: <ref *109> ƒ isNumber(length: 1) {},
        isString: <ref *110> ƒ isString(length: 1) {},
        isSymbol: <ref *111> ƒ isSymbol(length: 1) {},
        isUndefined: <ref *112> ƒ isUndefined(length: 1) {},
        isRegExp: [Circular: *70],
        isObject: <ref *113> ƒ isObject(length: 1) {},
        isDate: [Circular: *62],
        isFunction: <ref *114> ƒ isFunction(length: 1) {},
        isError: [Circular: *69],
        isPrimitive: <ref *115> ƒ isPrimitive(length: 1) {},
        isBuffer: <ref *116> ƒ isBuffer(length: 1) {},
        log: <ref *117> ƒ log2(length: 0) {},
        inherits: <ref *118> ƒ inherits2(length: 2) {},
        toUSVString: <ref *119> ƒ toUSVString(length: 1) {},
        promisify: <ref *120> ƒ promisify2(length: 1) {
            custom: Symbol(nodejs.util.promisify.custom)
        },
        callbackify: [Circular: *6],
        isDeepStrictEqual: <ref *121> ƒ isDeepStrictEqual(length: 2) {},
        TextDecoder: [Circular: *2],
        TextEncoder: [Circular: *3],
        parseArgs: <ref *122> ƒ parseArgs(length: 1) {},
        styleText: <ref *123> ƒ styleText(length: 2) {},
        getSystemErrorName: <ref *124> ƒ getSystemErrorName(length: 1) {},
        aborted: [Circular: *5]
    },
    deprecate: [Circular: *12],
    format: [Circular: *9],
    formatWithOptions: [Circular: *10],
    getSystemErrorName: [Circular: *124],
    inherits: [Circular: *118],
    inspect: [Circular: *13],
    isArray: [Circular: *105],
    isBoolean: [Circular: *106],
    isBuffer: [Circular: *116],
    isDate: [Circular: *62],
    isDeepStrictEqual: [Circular: *121],
    isError: [Circular: *69],
    isFunction: [Circular: *114],
    isNull: [Circular: *107],
    isNullOrUndefined: [Circular: *108],
    isNumber: [Circular: *109],
    isObject: [Circular: *113],
    isPrimitive: [Circular: *115],
    isRegExp: [Circular: *70],
    isString: [Circular: *110],
    isSymbol: [Circular: *111],
    isUndefined: [Circular: *112],
    log: [Circular: *117],
    parseArgs: [Circular: *122],
    promisify: [Circular: *120],
    stripVTControlCharacters: [Circular: *11],
    styleText: [Circular: *123],
    toUSVString: [Circular: *119],
    types: [Circular: *60]
}
```
