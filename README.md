...
[Object: null prototype] {
    ...
    default: EventEmitter {
        ...
        stdin: <ref *216> ReadStream {
            ...
            _maxListeners: undefined,
            _eventsCount: NaN,
            on: <ref *229> ƒ (length: 2) {},
            addListener: [Circular: *229],
            ref: ƒ (length: 0) {},
            unref: ƒ (length: 0) {},
            pause: ƒ (length: 0) {},
            resume: ƒ (length: 0) {},
        ...
        [get/set] title: "bun",
        umask: <ref *244> ƒ umask(length: 1) {},
        unref: <ref *245> ƒ unref(length: 1) {},
        uptime: <ref *246> ƒ uptime(length: 1) {},
        version: "v26.3.0",
        versions: <ref *247> {
            node: "26.3.0",
            bun: "1.4.0",
        ...
        getegid: <ref *248> ƒ getegid(length: 0) {},
        geteuid: <ref *249> ƒ geteuid(length: 0) {},
        getgid: <ref *250> ƒ getgid(length: 0) {},
        getgroups: <ref *251> ƒ getgroups(length: 0) {},
        getuid: <ref *252> ƒ getuid(length: 0) {},
        setegid: <ref *253> ƒ setegid(length: 1) {},
        seteuid: <ref *254> ƒ seteuid(length: 1) {},
        setgid: <ref *255> ƒ setgid(length: 1) {},
        setgroups: <ref *256> ƒ setgroups(length: 1) {},
        setuid: <ref *257> ƒ setuid(length: 1) {},
        _exiting: false,
    ...
    getMaxListeners: ƒ getMaxListeners(length: 0) {},
    getegid: [Circular: *248],
    geteuid: [Circular: *249],
    getgid: [Circular: *250],
    getgroups: [Circular: *251],
    getuid: [Circular: *252],
    ...
    setegid: [Circular: *253],
    seteuid: [Circular: *254],
    setgid: [Circular: *255],
    setgroups: [Circular: *256],
    setuid: [Circular: *257],
    stderr: [Circular: *57],
    stdin: [Circular: *216],
    stdout: [Circular: *236],
...
[Object: null prototype] {
    ...
    context: <ref *4> {
        ...
        Bun: {
            ...
            readableStreamToArray: ƒ readableStreamToArray(length: 1) {},
            readableStreamToArrayBuffer: ƒ readableStreamToArrayBuffer(length: 1) {},
            readableStreamToBytes: ƒ readableStreamToBytes(length: 1) {},
            readableStreamToBlob: ƒ readableStreamToBlob(length: 1) {},
            readableStreamToFormData: ƒ readableStreamToFormData(length: 1) {},
            readableStreamToJSON: ƒ readableStreamToJSON(length: 1) {},
        ...
        process: EventEmitter {
            ...
            stdin: ReadStream {
                ...
                _maxListeners: undefined,
                _eventsCount: NaN,
                on: <ref *492> ƒ (length: 2) {},
                addListener: [Circular: *492],
                ref: ƒ (length: 0) {},
                unref: ƒ (length: 0) {},
                pause: ƒ (length: 0) {},
                resume: ƒ (length: 0) {},
        ...
        BuildError: <ref *533> ƒ BuildMessage(length: 0) {},
        BuildMessage: [Circular: *533],
        Crypto: ƒ Crypto(length: 0) {},
        HTMLRewriter: ƒ HTMLRewriter(length: 0) {},
        Request: ƒ Request(length: 0) {},
        ResolveError: <ref *537> ƒ ResolveMessage(length: 0) {},
        ResolveMessage: [Circular: *537],
...
[Object: null prototype] {
    ...
    default: {
        ...
        setTraceSigInt: <ref *66> ƒ setTraceSigInt(length: 1) {},
        stripVTControlCharacters: <ref *67> ƒ stripVTControlCharacters(length: 1) {},
        toUSVString: <ref *68> ƒ toUSVString(length: 1) {},
        aborted: [Circular: *7],
        types: <ref *69> {
            isExternal: ƒ isExternal(length: 1) {},
            isDate: <ref *71> ƒ isDate(length: 1) {},
            ...
            isRegExp: <ref *79> ƒ isRegExp(length: 1) {},
        ...
        parseEnv: <ref *114> ƒ parseEnv(length: 1) {},
        parseArgs: <ref *115> ƒ parseArgs(length: 1) {},
        TextDecoder: [Circular: *4],
        TextEncoder: [Circular: *5],
        MIMEType: [Circular: *3],
        MIMEParams: [Circular: *2],
        isArray: <ref *116> ƒ isArray(length: 1) {},
        isBoolean: <ref *117> ƒ isBoolean(length: 1) {},
        isBuffer: <ref *118> ƒ isBuffer(length: 1) {},
        isNull: <ref *119> ƒ isNull(length: 1) {},
        isNullOrUndefined: <ref *120> ƒ isNullOrUndefined(length: 1) {},
        isNumber: <ref *121> ƒ isNumber(length: 1) {},
        isString: <ref *122> ƒ isString(length: 1) {},
        isSymbol: <ref *123> ƒ isSymbol(length: 1) {},
        isUndefined: <ref *124> ƒ isUndefined(length: 1) {},
        isRegExp: [Circular: *79],
        isObject: <ref *125> ƒ isObject(length: 1) {},
        isDate: [Circular: *71],
        isError: <ref *126> ƒ jsFunctionIsError(length: 1) {},
        isFunction: <ref *127> ƒ isFunction(length: 1) {},
        isPrimitive: <ref *128> ƒ isPrimitive(length: 1) {},
        log: <ref *129> ƒ log2(length: 0) {}
    },
    ...
    inspect: [Circular: *17],
    isArray: [Circular: *116],
    isBoolean: [Circular: *117],
    isBuffer: [Circular: *118],
    isDate: [Circular: *71],
    isDeepStrictEqual: [Circular: *64],
    isError: [Circular: *126],
    isFunction: [Circular: *127],
    isNull: [Circular: *119],
    isNullOrUndefined: [Circular: *120],
    isNumber: [Circular: *121],
    isObject: [Circular: *125],
    isPrimitive: [Circular: *128],
    isRegExp: [Circular: *79],
    isString: [Circular: *122],
    isSymbol: [Circular: *123],
    isUndefined: [Circular: *124],
    log: [Circular: *129],
    parseArgs: [Circular: *115],
    parseEnv: [Circular: *114],
    promisify: [Circular: *65],
    setTraceSigInt: [Circular: *66],
    stripVTControlCharacters: [Circular: *67],
    styleText: [Circular: *13],
    toUSVString: [Circular: *68],
    types: [Circular: *69]
}
```
