...
_Last updated on <!-- lastUpdated:start -->Mar 17, 2025 with Bun 1.2.6 Node.js v22.14.0<!-- lastUpdated:end -->._
...
```js
{
    ...
    IncomingMessage: <ref *6> ƒ IncomingMessage(length: 2) {
        prototype: IncomingMessage {
            ...
            [get/set] rawTrailers: [],
            [get/set] trailers: <ref *21> [Object: null prototype] {},
    ...
    MessageEvent: <ref *24> ƒ MessageEvent(length: 1) {},
    OutgoingMessage: <ref *25> ƒ OutgoingMessage(length: 1) {
        prototype: OutgoingMessage {
            constructor: [Circular: *25],
            _keepAliveTimeout: 0,
            ...
            [get/set] headers: [Circular: *21],
            addTrailers: ƒ addTrailers(length: 1) {},
            setTimeout: ƒ setTimeout(length: 2) {},
            [get/set] connection: <ref *42> Socket {
                _events: {
                    close: undefined,
                    error: undefined,
                    prefinish: undefined,
    ...
    Server: <ref *53> ƒ Server(length: 2) {
        prototype: Server {
            constructor: [Circular: *53],
            ref: ƒ ref(length: 0) {},
    ...
    ServerResponse: <ref *65> ƒ ServerResponse(length: 2) {
        prototype: ServerResponse {
            ...
            _send: ƒ _send(length: 4) {},
            writeHead: <ref *78> ƒ writeHead(length: 3) {},
            ...
            destroy: ƒ destroy(length: 1) {},
            flushHeaders: ƒ flushHeaders(length: 0) {},
            writeHeader: [Circular: *78]
        }
    },
    WebSocket: <ref *82> ƒ WebSocket(length: 1) {
        CONNECTING: 0,
        OPEN: 1,
        CLOSING: 2,
        CLOSED: 3
    },
    createServer: <ref *83> ƒ createServer(length: 2) {},
    default: {
        Agent: [Circular: *2],
        Server: [Circular: *53],
        METHODS: [Circular: *23],
        STATUS_CODES: [Circular: *52],
        createServer: [Circular: *83],
        ServerResponse: [Circular: *65],
        IncomingMessage: [Circular: *6],
        request: <ref *85> ƒ request(length: 3) {},
        get: <ref *86> ƒ get(length: 3) {},
        [get/set] maxHeaderSize: 16384,
        validateHeaderName: <ref *87> ƒ validateHeaderName(length: 2) {},
        validateHeaderValue: <ref *88> ƒ validateHeaderValue(length: 2) {},
        setMaxIdleHTTPParsers: <ref *89> ƒ setMaxIdleHTTPParsers(length: 1) {},
        globalAgent: <ref *90> Agent {
            _events: [Object: null prototype] {},
            _eventsCount: 0,
            _maxListeners: undefined,
            defaultPort: 80,
        ...
        OutgoingMessage: [Circular: *25],
        WebSocket: [Circular: *82],
        CloseEvent: [Circular: *5],
        MessageEvent: [Circular: *24]
    },
    get: [Circular: *86],
    globalAgent: [Circular: *90],
    maxHeaderSize: 16384,
    request: [Circular: *85],
    setMaxIdleHTTPParsers: [Circular: *89],
    validateHeaderName: [Circular: *87],
    validateHeaderValue: [Circular: *88]
}
```
...
(node:2197) [DEP0125] DeprecationWarning: The _stream_wrap module is deprecated.
...
```js
{
    ...
    DiffieHellman: <ref *11> ƒ DiffieHellman(length: 2) {},
    DiffieHellmanGroup: <ref *12> ƒ DiffieHellmanGroup(length: 1) {},
    ECDH: <ref *13> ƒ ECDH(length: 2) {
        convertKey: ƒ convertKey(length: 3) {}
    },
    Hash: <ref *15> ƒ Hash(length: 2) {},
    Hmac: <ref *16> ƒ Hmac(length: 3) {},
    KeyObject: <ref *17> class KeyObject {},
    Sign: <ref *18> ƒ Sign(length: 2) {},
    Verify: <ref *19> ƒ Verify(length: 2) {},
    X509Certificate: <ref *20> ƒ X509Certificate(length: 1) {},
    ...
    createPrivateKey: <ref *26> ƒ _createPrivateKey(length: 1) {},
    createPublicKey: <ref *27> ƒ _createPublicKey(length: 1) {},
    createSecretKey: <ref *28> ƒ (length: 2) {},
    createSign: <ref *29> ƒ createSign(length: 2) {},
    createVerify: <ref *30> ƒ createVerify(length: 2) {},
    default: {
        getHashes: <ref *32> ƒ (length: 0) {},
        pbkdf2Sync: <ref *33> ƒ pbkdf2Sync(length: 5) {},
        pbkdf2: <ref *34> ƒ pbkdf2(length: 6) {},
        Cipher: [Circular: *7],
        createCipher: [Circular: *7],
        Cipheriv: [Circular: *8],
        createCipheriv: [Circular: *8],
        ...
        createDecipheriv: [Circular: *10],
        getCiphers: <ref *35> ƒ getCiphers(length: 0) {},
        listCiphers: [Circular: *35],
        getRandomValues: <ref *36> ƒ (length: 1) {},
        constants: [Circular: *21],
        generateKeySync: <ref *37> ƒ (length: 2) {},
        generateKey: <ref *38> ƒ (length: 3) {},
        generateKeyPairSync: <ref *39> ƒ _generateKeyPairSync(length: 2) {},
        generateKeyPair: <ref *40> ƒ _generateKeyPair(length: 3) {},
        createSecretKey: [Circular: *28],
        createPrivateKey: [Circular: *26],
        createPublicKey: [Circular: *27],
        KeyObject: [Circular: *17],
        publicEncrypt: <ref *41> ƒ (length: 2) {},
        privateDecrypt: <ref *42> ƒ (length: 2) {},
        privateEncrypt: <ref *43> ƒ (length: 2) {},
        publicDecrypt: <ref *44> ƒ (length: 2) {},
        hash: <ref *45> ƒ hash(length: 2) {},
        getFips: <ref *46> ƒ getFips(length: 0) {},
        randomUUID: <ref *47> ƒ randomUUID(length: 1) {},
        getCurves: <ref *48> ƒ getCurves(length: 0) {},
        getCipherInfo: <ref *49> ƒ getCipherInfo(length: 1) {},
        scrypt: <ref *50> ƒ ::bunternal::(length: 5) {},
        scryptSync: <ref *51> ƒ ::bunternal::(length: 4) {},
        timingSafeEqual: <ref *52> ƒ timingSafeEqual(length: 2) {},
        webcrypto: <ref *53> Crypto {
            subtle: <ref *54> SubtleCrypto {}
        },
        subtle: [Circular: *54],
        X509Certificate: [Circular: *20],
        Certificate: [Circular: *2],
        Sign: [Circular: *18],
        sign: <ref *55> ƒ sign(length: 4) {},
        createSign: [Circular: *29],
        Verify: [Circular: *19],
        verify: <ref *56> ƒ verify(length: 4) {},
        ...
        randomInt: <ref *58> ƒ randomInt(length: 2) {},
        randomFill: <ref *59> ƒ randomFill(length: 4) {},
        randomFillSync: <ref *60> ƒ randomFillSync(length: 3) {},
        DiffieHellmanGroup: [Circular: *12],
        createDiffieHellmanGroup: [Circular: *12],
        getDiffieHellman: [Circular: *12],
        createDiffieHellman: [Circular: *22],
        DiffieHellman: [Circular: *11],
        diffieHellman: <ref *61> ƒ diffieHellman(length: 1) {},
        ECDH: [Circular: *13],
        createECDH: [Circular: *23]
    },
    diffieHellman: [Circular: *61],
    generateKey: [Circular: *38],
    generateKeyPair: [Circular: *40],
    generateKeyPairSync: [Circular: *39],
    generateKeySync: [Circular: *37],
    getCipherInfo: [Circular: *49],
    getCiphers: [Circular: *35],
    getCurves: [Circular: *48],
    getDiffieHellman: [Circular: *12],
    getFips: [Circular: *46],
    getHashes: [Circular: *32],
    getRandomValues: [Circular: *36],
    hash: [Circular: *45],
    listCiphers: [Circular: *35],
    pbkdf2: [Circular: *34],
    pbkdf2Sync: [Circular: *33],
    privateDecrypt: [Circular: *42],
    privateEncrypt: [Circular: *43],
    publicDecrypt: [Circular: *44],
    publicEncrypt: [Circular: *41],
    randomBytes: [Circular: *57],
    randomFill: [Circular: *59],
    randomFillSync: [Circular: *60],
    randomInt: [Circular: *58],
    randomUUID: [Circular: *47],
    scrypt: [Circular: *50],
    scryptSync: [Circular: *51],
    sign: [Circular: *55],
    subtle: [Circular: *54],
    timingSafeEqual: [Circular: *52],
    verify: [Circular: *56],
    webcrypto: [Circular: *53]
}
```
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1742170648854-1/module.mjs: "/tmp/fs-fixture-1742170648854-1/module.mjs"
        },
...
<ref *1> {
    Module: <ref *2> ƒ Module(length: 1) {
        _cache: <ref *3> {
            ...
            /tmp/fs-fixture-1742170648854-1/module.mjs: {
                exports: {}
            },
            module: {
                exports: [Circular: *1]
            },
            /tmp/fs-fixture-1742170648854-1/inspect.mjs: {
                exports: {
        ...
        findSourceMap: <ref *28> ƒ findSourceMap(length: 0) {},
        ...
        register: <ref *34> ƒ register(length: 1) {},
        runMain: <ref *35> ƒ runMain(length: 0) {},
        SourceMap: <ref *36> ƒ SourceMap(length: 1) {},
        syncBuiltinESMExports: <ref *37> ƒ syncBuiltinESMExports(length: 0) {},
        wrap: <ref *38> ƒ wrap(length: 1) {},
        Module: [Circular: *2]
    },
    SourceMap: [Circular: *36],
    _cache: [Circular: *3],
    _debug: [Circular: *12],
    ...
    register: [Circular: *34],
    runMain: [Circular: *35],
    syncBuiltinESMExports: [Circular: *37],
    wrap: [Circular: *38]
}
```
...
```js
{
    ...
    default: {
        performance: <ref *13> {
            ...
            timeOrigin: 1742170649983.397,
            toJSON: ƒ toJSON(length: 1) {},
            onresourcetimingbufferfull: null,
            nodeTiming: PerformanceNodeTiming {
                v8Start: 1742170649983.397,
                nodeStart: 1742170649983.397,
                environment: 1742170649983.397,
                bootstrapComplete: 1742170649983.397,
                idleTime: 1,
                loopStart: 1,
                loopExit: -1
            },
...
[Object: null prototype] {
    ...
    argv: <ref *26> [
        ...
        "/tmp/fs-fixture-1742170648854-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        env: <ref *118>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_a38627d0-0120-4ed0-bfbd-37f6492d5024",
            ...
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_a38627d0-0120-4ed0-bfbd-37f6492d5024",
            PIPX_HOME: "/opt/pipx",
            ...
            STATS_D: "true",
            GITHUB_RUN_ID: "13888843924",
            STATS_VMFE: "true",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "4221475cf6d248a87cfce3e4573085a5ddf8ad6a",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_9fe38918-2314-452b-82fc-54baf2a1d5ea",
            INVOCATION_ID: "f17556ed2e164162a12c231f7f19aefb",
            ...
            RUNNER_NAME: "GitHub-Actions-1000000094",
            ...
            GITHUB_SHA: "4221475cf6d248a87cfce3e4573085a5ddf8ad6a",
            ...
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_a38627d0-0120-4ed0-bfbd-37f6492d5024",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_a38627d0-0120-4ed0-bfbd-37f6492d5024",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_a38627d0-0120-4ed0-bfbd-37f6492d5024",
...
```js
{
    ...
    default: EventEmitter {
        ...
        env: <ref *31> {
            [get/set] GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_a38627d0-0120-4ed0-bfbd-37f6492d5024",
            ...
            [get/set] GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_a38627d0-0120-4ed0-bfbd-37f6492d5024",
            ...
            [get/set] ANDROID_NDK_LATEST_HOME: "/usr/local/lib/android/sdk/ndk/28.0.13004108",
            ...
            [get/set] ImageVersion: "20250309.1.0",
            ...
            [get/set] GOROOT_1_23_X64: "/opt/hostedtoolcache/go/1.23.7/x64",
            [get/set] JOURNAL_STREAM: "8:4861",
            ...
            [get/set] STATS_D: "true",
            [get/set] GITHUB_RUN_ID: "13888843924",
            [get/set] STATS_VMFE: "true",
            [get/set] GITHUB_REF_TYPE: "branch",
            [get/set] BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            [get/set] GITHUB_WORKFLOW_SHA: "4221475cf6d248a87cfce3e4573085a5ddf8ad6a",
            ...
            [get/set] RUNNER_TRACKING_ID: "github_9fe38918-2314-452b-82fc-54baf2a1d5ea",
            [get/set] INVOCATION_ID: "f17556ed2e164162a12c231f7f19aefb",
            ...
            [get/set] RUNNER_NAME: "GitHub-Actions-1000000094",
            ...
            [get/set] GITHUB_SHA: "4221475cf6d248a87cfce3e4573085a5ddf8ad6a",
            ...
            [get/set] GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_a38627d0-0120-4ed0-bfbd-37f6492d5024",
            ...
            [get/set] GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_a38627d0-0120-4ed0-bfbd-37f6492d5024",
            ...
            [get/set] GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_a38627d0-0120-4ed0-bfbd-37f6492d5024",
        ...
        release: <ref *46> {
            name: "node",
            sourceUrl: "https://github.com/oven-sh/bun/releases/download/bun-v1.2.6/bun-linux-x64-baseline.zip",
        ...
        revision: "74768449bc109ca301da7b822987c502e905f9b3",
        ...
        versions: <ref *232> {
            ...
            uwebsockets: "74768449bc109ca301da7b822987c502e905f9b3",
            webkit: "2ffd4be9f9513c30333d9e23c175cab4760584e3",
            zig: "0.14.0",
            ...
            usockets: "74768449bc109ca301da7b822987c502e905f9b3",
...
```js
{
    ...
    context: <ref *4> {
        ...
        Bun: {
            ...
            argv: [
                "/home/runner/.bun/bin/bun",
                "/tmp/fs-fixture-1742170648854-1/repl.mjs"
            ],
            ...
            main: "/tmp/fs-fixture-1742170648854-1/repl.mjs",
            ...
            sql: <ref *177> ƒ sql(length: 1) {
                reserve: ƒ (length: 0) {},
                commitDistributed: ƒ (length: 0) {},
                rollbackDistributed: ƒ (length: 0) {},
                beginDistributed: <ref *181> ƒ (length: 0) {},
                distributed: [Circular: *181],
                connect: ƒ (length: 0) {},
                unsafe: ƒ (length: 0) {},
                file: async ƒ (length: 0) {},
                begin: <ref *185> ƒ (length: 0) {},
                transaction: [Circular: *185],
                close: <ref *186> ƒ (length: 0) {},
                end: [Circular: *186],
                flush: ƒ (length: 0) {}
            },
            postgres: [Circular: *177],
            SQL: ƒ SQL(length: 1) {},
        ...
        process: EventEmitter {
            ...
            stderr: WriteStream {
                ...
                pos: undefined,
                bytesWritten: 0,
                _write: <ref *249> ƒ underscoreWriteFast(length: 3) {},
                write: <ref *250> ƒ writeFast(length: 3) {},
                _events: {
                    close: undefined,
                    error: undefined,
                    prefinish: undefined,
                ...
                readable: false,
                _type: "fs",
                destroySoon: <ref *257> ƒ (length: 2) {},
                _destroy: ƒ (length: 2) {},
                _isStdio: true,
                Symbol(kFs): <ref *259> {
                    appendFile: ƒ appendFile(length: 4) {},
                    ...
                    W_OK: 2,
                    X_OK: 1,
                    constants: <ref *355> [Object: null prototype] {
                        UV_FS_SYMLINK_DIR: 1,
                        UV_FS_SYMLINK_JUNCTION: 2,
                        O_RDONLY: 0,
                        O_WRONLY: 1,
            ...
            stdin: ReadStream {
                ...
                _maxListeners: undefined,
                _eventsCount: NaN,
                on: <ref *420> ƒ (length: 2) {},
                addListener: [Circular: *420],
                ref: ƒ (length: 0) {},
                unref: ƒ (length: 0) {},
                pause: ƒ (length: 0) {},
                resume: ƒ (length: 0) {},
                _read: ƒ triggerRead(length: 1) {},
                Symbol(kFs): [Circular: *259],
                Symbol(kReadStreamFastPath): false,
                Symbol(kCapture): false
            },
            stdout: WriteStream {
        ...
        BuildError: <ref *472> ƒ BuildMessage(length: 0) {},
        BuildMessage: [Circular: *472],
        Crypto: ƒ Crypto(length: 0) {},
        HTMLRewriter: ƒ HTMLRewriter(length: 0) {},
        Request: ƒ Request(length: 0) {},
        ResolveError: <ref *476> ƒ ResolveMessage(length: 0) {},
        ResolveMessage: [Circular: *476],
...
(node:3105) [DEP0025] DeprecationWarning: sys is deprecated. Use util instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
```js
{
    ...
    default: {
        ...
        parseEnv: <ref *111> ƒ parseEnv(length: 1) {},
        parseArgs: <ref *112> ƒ parseArgs(length: 1) {},
        TextDecoder: [Circular: *2],
        TextEncoder: [Circular: *3],
        isArray: <ref *113> ƒ isArray(length: 1) {},
        isBoolean: <ref *114> ƒ isBoolean(length: 1) {},
        isBuffer: <ref *115> ƒ isBuffer(length: 1) {},
        isNull: <ref *116> ƒ isNull(length: 1) {},
        isNullOrUndefined: <ref *117> ƒ isNullOrUndefined(length: 1) {},
        isNumber: <ref *118> ƒ isNumber(length: 1) {},
        isString: <ref *119> ƒ isString(length: 1) {},
        isSymbol: <ref *120> ƒ isSymbol(length: 1) {},
        isUndefined: <ref *121> ƒ isUndefined(length: 1) {},
        isRegExp: [Circular: *76],
        isObject: <ref *122> ƒ isObject(length: 1) {},
        isDate: [Circular: *68],
        isError: <ref *123> ƒ jsFunctionIsError(length: 1) {},
        isFunction: <ref *124> ƒ isFunction(length: 1) {},
        isPrimitive: <ref *125> ƒ isPrimitive(length: 1) {},
        log: <ref *126> ƒ log2(length: 0) {}
    },
    ...
    inspect: [Circular: *15],
    isArray: [Circular: *113],
    isBoolean: [Circular: *114],
    isBuffer: [Circular: *115],
    isDate: [Circular: *68],
    isDeepStrictEqual: [Circular: *62],
    isError: [Circular: *123],
    isFunction: [Circular: *124],
    isNull: [Circular: *116],
    isNullOrUndefined: [Circular: *117],
    isNumber: [Circular: *118],
    isObject: [Circular: *122],
    isPrimitive: [Circular: *125],
    isRegExp: [Circular: *76],
    isString: [Circular: *119],
    isSymbol: [Circular: *120],
    isUndefined: [Circular: *121],
    log: [Circular: *126],
    parseArgs: [Circular: *112],
    parseEnv: [Circular: *111],
