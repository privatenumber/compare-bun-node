...
DeprecationWarning: The _tls_common module is deprecated. Use `node:tls` instead.
 code: "DEP0192"

      at node:_tls_common (node:_tls_common:3:20)
...
<ref *1> [Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 1) {
        ...
        register: <ref *35> ƒ register(length: 1) {},
        [get/set] runMain: <ref *36> ƒ runMain(length: 2) {},
        SourceMap: <ref *37> ƒ SourceMap(length: 0) {},
        syncBuiltinESMExports: <ref *38> ƒ syncBuiltinESMExports(length: 0) {},
        wrap: <ref *39> ƒ wrap(length: 1) {},
        [get/set] wrapper: [
    ...
    prototype: [Circular: *32],
    register: [Circular: *35],
    runMain: [Circular: *36],
    syncBuiltinESMExports: [Circular: *38],
    wrap: [Circular: *39],
    wrapper: [
        "(function(exports,require,module,__filename,__dirname){",
        "})"
...
[Object: null prototype] {
    ...
    default: EventEmitter {
        ...
        execve: <ref *34> ƒ execve(length: 3) {},
        exit: <ref *35> ƒ exit(length: 1) {},
        [get/set] exitCode: undefined,
        features: <ref *36> {
            inspector: true,
            debug: false,
        ...
        getActiveResourcesInfo: <ref *37> ƒ getActiveResourcesInfo(length: 0) {},
        getBuiltinModule: <ref *38> ƒ getBuiltinModule(length: 1) {},
        hasUncaughtExceptionCaptureCallback: <ref *39> ƒ hasUncaughtExceptionCaptureCallback(length: 0) {},
        ...
        stderr: <ref *57> WriteStream {
            ...
            pos: undefined,
            bytesWritten: 0,
            _write: <ref *58> ƒ underscoreWriteFast(length: 3) {},
            write: <ref *59> ƒ writeFast(length: 3) {},
            ...
            Symbol(kFs): <ref *66> {
                ...
                W_OK: 2,
                X_OK: 1,
                constants: <ref *163> [Object: null prototype] {
                    UV_FS_SYMLINK_DIR: 1,
                    UV_FS_SYMLINK_JUNCTION: 2,
                    O_RDONLY: 0,
                    O_WRONLY: 1,
                ...
                ReadStream: <ref *166> ƒ ReadStream(length: 2) {},
                WriteStream: <ref *167> ƒ WriteStream(length: 2) {},
                [get/set] FileReadStream: [Circular: *166],
                [get/set] Utf8Stream: class Utf8Stream extends EventEmitter {},
                [get/set] FileWriteStream: [Circular: *167],
                promises: {
                    access: async ƒ access(length: 3) {},
                    appendFile: async ƒ appendFile(length: 1) {},
                    close: async ƒ close(length: 1) {},
        ...
        stdin: <ref *217> ReadStream {
            ...
            _maxListeners: undefined,
            _eventsCount: 4,
            on: <ref *226> ƒ (length: 2) {},
            addListener: [Circular: *226],
            ref: ƒ (length: 0) {},
            unref: ƒ (length: 0) {},
            pause: ƒ (length: 0) {},
            resume: ƒ (length: 0) {},
        ...
        [get/set] title: "bun",
        umask: <ref *241> ƒ umask(length: 1) {},
        unref: <ref *242> ƒ unref(length: 1) {},
        uptime: <ref *243> ƒ uptime(length: 1) {},
        version: "v26.3.0",
        versions: <ref *244> {
            node: "26.3.0",
            bun: "1.4.0",
        ...
        getegid: <ref *245> ƒ getegid(length: 0) {},
        geteuid: <ref *246> ƒ geteuid(length: 0) {},
        getgid: <ref *247> ƒ getgid(length: 0) {},
        getgroups: <ref *248> ƒ getgroups(length: 0) {},
        getuid: <ref *249> ƒ getuid(length: 0) {},
        setegid: <ref *250> ƒ setegid(length: 1) {},
        seteuid: <ref *251> ƒ seteuid(length: 1) {},
        setgid: <ref *252> ƒ setgid(length: 1) {},
        setgroups: <ref *253> ƒ setgroups(length: 1) {},
        setuid: <ref *254> ƒ setuid(length: 1) {},
        _exiting: false,
    ...
    exit: [Circular: *35],
    exitCode: undefined,
    features: [Circular: *36],
    getActiveResourcesInfo: [Circular: *37],
    getBuiltinModule: [Circular: *38],
    getMaxListeners: ƒ getMaxListeners(length: 0) {},
    getegid: [Circular: *245],
    geteuid: [Circular: *246],
    getgid: [Circular: *247],
    getgroups: [Circular: *248],
    getuid: [Circular: *249],
    hasUncaughtExceptionCaptureCallback: [Circular: *39],
    hrtime: [Circular: *40],
    isBun: true,
    kill: [Circular: *42],
    ...
    setUncaughtExceptionCaptureCallback: [Circular: *56],
    setegid: [Circular: *250],
    seteuid: [Circular: *251],
    setgid: [Circular: *252],
    setgroups: [Circular: *253],
    setuid: [Circular: *254],
    stderr: [Circular: *57],
    stdin: [Circular: *217],
    stdout: [Circular: *233],
...
[Object: null prototype] {
    ...
    CompressionStream: <ref *3> ƒ CompressionStream(length: 0) {},
    CountQueuingStrategy: <ref *4> ƒ CountQueuingStrategy(length: 1) {},
    DecompressionStream: <ref *5> ƒ DecompressionStream(length: 0) {},
...
[Object: null prototype] {
    ...
    debug: <ref *10> ƒ debuglog(length: 1) {},
    ...
    default: {
        ...
        styleText: <ref *14> ƒ styleText(length: 3) {},
        formatWithOptions: <ref *15> ƒ formatWithOptions(length: 1) {},
        getCallSites: <ref *16> ƒ getCallSites(length: 0) {},
        getSystemErrorName: <ref *17> ƒ getSystemErrorName(length: 1) {},
        inherits: <ref *18> ƒ inherits2(length: 2) {},
        ...
        isDeepStrictEqual: <ref *68> ƒ isDeepStrictEqual(length: 3) {},
        promisify: <ref *69> ƒ promisify2(length: 1) {
            custom: Symbol(nodejs.util.promisify.custom)
        },
        setTraceSigInt: <ref *70> ƒ setTraceSigInt(length: 1) {},
        stripVTControlCharacters: <ref *71> ƒ stripVTControlCharacters(length: 1) {},
        toUSVString: <ref *72> ƒ toUSVString(length: 1) {},
        aborted: [Circular: *7],
        types: <ref *73> {
            isExternal: ƒ isExternal(length: 1) {},
            isDate: <ref *75> ƒ isDate(length: 1) {},
            ...
            isRegExp: <ref *83> ƒ isRegExp(length: 1) {},
        ...
        parseEnv: <ref *118> ƒ parseEnv(length: 1) {},
        parseArgs: <ref *119> ƒ parseArgs(length: 1) {},
        TextDecoder: [Circular: *4],
        TextEncoder: [Circular: *5],
        MIMEType: [Circular: *3],
        MIMEParams: [Circular: *2],
        isArray: <ref *120> ƒ isArray(length: 1) {},
        isBoolean: <ref *121> ƒ isBoolean(length: 1) {},
        isBuffer: <ref *122> ƒ isBuffer(length: 1) {},
        isNull: <ref *123> ƒ isNull(length: 1) {},
        isNullOrUndefined: <ref *124> ƒ isNullOrUndefined(length: 1) {},
        isNumber: <ref *125> ƒ isNumber(length: 1) {},
        isString: <ref *126> ƒ isString(length: 1) {},
        isSymbol: <ref *127> ƒ isSymbol(length: 1) {},
        isUndefined: <ref *128> ƒ isUndefined(length: 1) {},
        isRegExp: [Circular: *83],
        isObject: <ref *129> ƒ isObject(length: 1) {},
        isDate: [Circular: *75],
        isError: <ref *130> ƒ jsFunctionIsError(length: 1) {},
        isFunction: <ref *131> ƒ isFunction(length: 1) {},
        isPrimitive: <ref *132> ƒ isPrimitive(length: 1) {},
        log: <ref *133> ƒ log2(length: 0) {}
    },
    deprecate: [Circular: *12],
    format: [Circular: *13],
    formatWithOptions: [Circular: *15],
    getCallSites: [Circular: *16],
    getSystemErrorName: [Circular: *17],
    inherits: [Circular: *18],
    inspect: [Circular: *19],
    isArray: [Circular: *120],
    isBoolean: [Circular: *121],
    isBuffer: [Circular: *122],
    isDate: [Circular: *75],
    isDeepStrictEqual: [Circular: *68],
    isError: [Circular: *130],
    isFunction: [Circular: *131],
    isNull: [Circular: *123],
    isNullOrUndefined: [Circular: *124],
    isNumber: [Circular: *125],
    isObject: [Circular: *129],
    isPrimitive: [Circular: *132],
    isRegExp: [Circular: *83],
    isString: [Circular: *126],
    isSymbol: [Circular: *127],
    isUndefined: [Circular: *128],
    log: [Circular: *133],
    parseArgs: [Circular: *119],
    parseEnv: [Circular: *118],
    promisify: [Circular: *69],
    setTraceSigInt: [Circular: *70],
    stripVTControlCharacters: [Circular: *71],
    styleText: [Circular: *14],
    toUSVString: [Circular: *72],
    types: [Circular: *73]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        fileURLToPathBuffer: <ref *22> ƒ fileURLToPathBuffer(length: 2) {},
        urlToHttpOptions: <ref *23> ƒ urlToHttpOptions(length: 1) {},
        domainToASCII: <ref *24> ƒ domainToAscii(length: 1) {},
        domainToUnicode: <ref *25> ƒ domainToUnicode(length: 1) {}
    },
    domainToASCII: [Circular: *24],
    domainToUnicode: [Circular: *25],
    fileURLToPath: [Circular: *21],
    fileURLToPathBuffer: [Circular: *22],
    format: [Circular: *19],
    parse: [Circular: *16],
    pathToFileURL: [Circular: *20],
    resolve: [Circular: *17],
    resolveObject: [Circular: *18],
    urlToHttpOptions: [Circular: *23]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        setFlagsFromString: <ref *12> ƒ ::bunternal::(length: 1) {},
...
[Object: null prototype] {
    ...
    assert: <ref *4> {
        fail: <ref *5> ƒ fail(length: 5) {},
        ok: <ref *6> ƒ ok(length: 0) {
            fail: [Circular: *5],
            [get/set] AssertionError: <ref *7> class AssertionError extends Error {},
            ok: [Circular: *6],
            equal: <ref *8> ƒ equal(length: 3) {},
            notEqual: <ref *9> ƒ notEqual(length: 3) {},
            deepEqual: <ref *10> ƒ deepEqual(length: 3) {},
            notDeepEqual: <ref *11> ƒ notDeepEqual(length: 3) {},
            deepStrictEqual: <ref *12> ƒ deepStrictEqual(length: 3) {},
            notDeepStrictEqual: <ref *13> ƒ notDeepStrictEqual(length: 3) {},
            strictEqual: <ref *14> ƒ strictEqual(length: 3) {},
            notStrictEqual: <ref *15> ƒ notStrictEqual(length: 3) {},
            partialDeepStrictEqual: <ref *16> ƒ partialDeepStrictEqual(length: 3) {},
            throws: <ref *17> ƒ throws(length: 1) {},
            rejects: <ref *18> async ƒ rejects(length: 1) {},
            doesNotThrow: <ref *19> ƒ doesNotThrow(length: 1) {},
            doesNotReject: <ref *20> async ƒ doesNotReject(length: 1) {},
            ifError: <ref *21> ƒ ifError(length: 1) {},
            match: <ref *22> ƒ match(length: 3) {},
            doesNotMatch: <ref *23> ƒ doesNotMatch(length: 3) {},
            [get/set] CallTracker: <ref *24> ƒ deprecated(length: 0) {},
            strict: <ref *25> ƒ strict(length: 0) {
                fail: [Circular: *5],
                AssertionError: [Circular: *7],
                ok: [Circular: *6],
                equal: [Circular: *14],
                notEqual: [Circular: *15],
                deepEqual: [Circular: *12],
                notDeepEqual: [Circular: *13],
                deepStrictEqual: [Circular: *12],
                notDeepStrictEqual: [Circular: *13],
                strictEqual: [Circular: *14],
                notStrictEqual: [Circular: *15],
                partialDeepStrictEqual: [Circular: *16],
                ...
                ifError: [Circular: *21],
                match: [Circular: *22],
                doesNotMatch: [Circular: *23],
                CallTracker: [Circular: *24],
                strict: [Circular: *25]
            }
        },
        equal: [Circular: *8],
    ...
    before: <ref *29> ƒ before(length: 2) {},
    beforeEach: <ref *30> ƒ beforeEach(length: 2) {},
    default: <ref *31> ƒ test(length: 3) {
        skip: <ref *32> ƒ (length: 3) {},
        todo: <ref *33> ƒ (length: 3) {},
        only: <ref *34> ƒ (length: 3) {},
        describe: <ref *35> ƒ describe(length: 3) {
            skip: ƒ (length: 3) {},
            todo: ƒ (length: 3) {},
            only: ƒ (length: 3) {}
        },
        ...
        run: <ref *42> ƒ run(length: 0) {},
        mock: <ref *43> MockTracker {},
        getTestContext: <ref *44> ƒ getTestContext(length: 0) {}
    },
    describe: [Circular: *35],
    getTestContext: [Circular: *44],
    it: [Circular: *31],
    mock: [Circular: *43],
    only: [Circular: *34],
    run: [Circular: *42],
    skip: [Circular: *32],
    snapshot: [Circular: *39],
    suite: [Circular: *35],
    test: [Circular: *31],
    todo: [Circular: *33]
}
