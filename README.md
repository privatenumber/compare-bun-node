...
_Last updated on <!-- lastUpdated:start -->Aug 31, 2026 with Bun 1.4.1 Node.js v24.19.0<!-- lastUpdated:end -->._
...
[Object: null prototype] {
    ...
    default: {
        ...
        shouldUseEnvProxy: <ref *12> ƒ shouldUseEnvProxy(length: 0) {}
    },
    globalAgent: [Circular: *4],
    shouldUseEnvProxy: [Circular: *12]
}
```
...
[Object: null prototype] {
    ...
    chunkExpression: <ref *6> /(?:^|\W)chunked(?:$|\W)/i,
    continueExpression: <ref *7> /(?:^|\W)100-continue(?:$|\W)/i,
    default: {
        _checkInvalidHeaderChar: [Circular: *3],
        _checkIsHttpToken: [Circular: *4],
        chunkExpression: [Circular: *6],
        continueExpression: [Circular: *7],
        CRLF: "\r\n",
        freeParser: <ref *9> ƒ freeParser(length: 3) {},
        methods: <ref *10> [
            "DELETE",
            "GET",
            "HEAD",
        ...
        isLenient: <ref *14> ƒ isLenient(length: 0) {},
        calculateLenientFlags: [Circular: *5],
        prepareError: <ref *15> ƒ prepareError(length: 3) {},
        kSkipPendingData: Symbol(SkipPendingData)
    },
    freeParser: [Circular: *9],
    isLenient: [Circular: *14],
    kIncomingMessage: Symbol(IncomingMessage),
    kSkipPendingData: Symbol(SkipPendingData),
    methods: [Circular: *10],
    parsers: [Circular: *11],
    prepareError: [Circular: *15]
}
```
...
[Object: null prototype] {
    ...
    continueExpression: <ref *7> /(?:^|\W)100-continue(?:$|\W)/i,
    default: {
        validateHeaderName: <ref *9> ƒ validateHeaderName(length: 2) {},
        validateHeaderValue: <ref *10> ƒ validateHeaderValue(length: 2) {},
        _checkIsHttpToken: [Circular: *4],
        _checkInvalidHeaderChar: [Circular: *3],
        chunkExpression: [Circular: *6],
        continueExpression: [Circular: *7],
        CRLF: "\r\n",
        freeParser: <ref *11> ƒ freeParser(length: 3) {},
        methods: <ref *12> [
            "DELETE",
            "GET",
            "HEAD",
    ...
    methods: [Circular: *12],
    parsers: [Circular: *13],
    prepareError: [Circular: *17],
    validateHeaderName: [Circular: *9],
    validateHeaderValue: [Circular: *10]
}
```
...
[Object: null prototype] {
    IncomingMessage: <ref *2> ƒ IncomingMessage(length: 1) {},
    default: {
        readStop: <ref *4> ƒ readStop(length: 1) {},
        readStart: <ref *5> ƒ readStart(length: 1) {},
        kReqShouldKeepAlive: Symbol(kReqShouldKeepAlive),
        IncomingMessage: [Circular: *2]
    },
    kReqShouldKeepAlive: Symbol(kReqShouldKeepAlive),
    readStart: [Circular: *5],
    readStop: [Circular: *4]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        kErrored: Symbol(errored),
        kSocket: Symbol(kSocket),
        kRejectNonStandardBodyWrites: Symbol(kRejectNonStandardBodyWrites),
        parseUniqueHeadersOption: <ref *5> ƒ parseUniqueHeadersOption(length: 1) {},
        validateHeaderName: <ref *6> ƒ validateHeaderName(length: 2) {},
        validateHeaderValue: <ref *7> ƒ validateHeaderValue(length: 2) {},
    ...
    kSocket: Symbol(kSocket),
    kUniqueHeaders: Symbol(kUniqueHeaders),
    parseUniqueHeadersOption: [Circular: *5],
    validateHeaderName: [Circular: *6],
    validateHeaderValue: [Circular: *7]
}
```
...
(node:2575) [DEP0125] DeprecationWarning: The _stream_wrap module is deprecated.
...
[Object: null prototype] {
    ...
    Stream: <ref *16> ƒ Stream(length: 1) {
        ...
        getDefaultHighWaterMark: <ref *42> ƒ getDefaultHighWaterMark(length: 0) {},
...
(node:2577) [DEP0125] DeprecationWarning: The _stream_wrap module is deprecated.
...
(node:2593) [DEP0192] DeprecationWarning: The _tls_common module is deprecated. Use `node:tls` instead.
(Use `bun --trace-warnings ...` to show where the warning was created)
```
...
(node:2609) [DEP0192] DeprecationWarning: The _tls_wrap module is deprecated. Use `node:tls` instead.
(Use `bun --trace-warnings ...` to show where the warning was created)
```
...
[Object: null prototype] {
    Assert: <ref *2> ƒ Assert(length: 1) {
        prototype: Assert {
            fail: <ref *4> ƒ fail(length: 5) {},
            ok: <ref *5> ƒ ok2(length: 0) {},
            equal: <ref *6> ƒ equal(length: 3) {},
            notEqual: <ref *7> ƒ notEqual(length: 3) {},
            deepEqual: <ref *8> ƒ deepEqual(length: 3) {},
            notDeepEqual: <ref *9> ƒ notDeepEqual(length: 3) {},
            deepStrictEqual: <ref *10> ƒ deepStrictEqual(length: 3) {},
    ...
    AssertionError: <ref *22> class AssertionError extends Error {},
    CallTracker: <ref *23> ƒ deprecated(length: 0) {},
    deepEqual: [Circular: *8],
    deepStrictEqual: [Circular: *10],
    default: ƒ ok(length: 0) {
        [get/set] AssertionError: [Circular: *22],
        [get/set] CallTracker: [Circular: *23],
        ok: [Circular: *5],
        fail: [Circular: *4],
        equal: [Circular: *6],
        notEqual: [Circular: *7],
        ...
        ifError: [Circular: *19],
        strict: <ref *25> ƒ strict(length: 0) {
            [get/set] AssertionError: [Circular: *22],
            [get/set] CallTracker: [Circular: *23],
            ok: [Circular: *5],
            fail: [Circular: *4],
...
[Object: null prototype] {
    ...
    deepEqual: [Circular: *10],
    deepStrictEqual: [Circular: *10],
    default: <ref *24> ƒ strict(length: 0) {
        [get/set] AssertionError: [Circular: *22],
        [get/set] CallTracker: [Circular: *23],
        ok: [Circular: *5],
        fail: [Circular: *4],
...
[Object: null prototype] {
    ...
    SlowBuffer: <ref *16> ƒ deprecated(length: 1) {},
...
[Object: null prototype] {
    ...
    Cipheriv: <ref *7> ƒ Cipheriv2(length: 4) {},
    Decipheriv: <ref *8> ƒ Decipheriv2(length: 4) {},
    ...
    Hash: <ref *13> ƒ deprecated(length: 2) {},
    Hmac: <ref *14> ƒ deprecated(length: 3) {},
    ...
    argon2: <ref *19> ƒ argon2(length: 3) {},
    argon2Sync: <ref *20> ƒ argon2Sync(length: 2) {},
    checkPrime: <ref *21> ƒ checkPrime(length: 3) {},
    checkPrimeSync: <ref *22> ƒ checkPrimeSync(length: 2) {},
    ...
    createCipheriv: <ref *24> ƒ createCipheriv(length: 4) {},
    createDecipheriv: <ref *25> ƒ createDecipheriv(length: 4) {},
    createDiffieHellman: <ref *26> ƒ createDiffieHellman(length: 4) {},
    ...
    createVerify: <ref *34> ƒ createVerify(length: 2) {},
    default: {
        getRandomValues: <ref *36> ƒ (length: 1) {},
        constants: [Circular: *23],
        KeyObject: [Circular: *15],
        generateKey: <ref *37> ƒ generateKey(length: 3) {},
        generateKeySync: <ref *38> ƒ generateKeySync(length: 2) {},
        generateKeyPair: <ref *39> ƒ generateKeyPair(length: 3) {},
        generateKeyPairSync: <ref *40> ƒ generateKeyPairSync(length: 2) {},
        createSecretKey: [Circular: *32],
        createPublicKey: [Circular: *31],
        createPrivateKey: [Circular: *30],
        hash: <ref *41> ƒ hash(length: 2) {},
        pbkdf2: <ref *42> ƒ pbkdf2(length: 6) {},
        pbkdf2Sync: <ref *43> ƒ pbkdf2Sync(length: 5) {},
        hkdf: <ref *44> ƒ hkdf(length: 6) {},
        hkdfSync: <ref *45> ƒ hkdfSync(length: 5) {},
        getCurves: <ref *46> ƒ getCurves(length: 0) {},
        getCipherInfo: <ref *47> ƒ getCipherInfo(length: 1) {},
        timingSafeEqual: <ref *48> ƒ timingSafeEqual(length: 2) {},
        webcrypto: <ref *49> Crypto {},
        subtle: <ref *50> SubtleCrypto {},
        X509Certificate: [Circular: *18],
        Certificate: [Circular: *2],
        Sign: [Circular: *16],
        sign: <ref *51> ƒ sign(length: 4) {},
        createSign: [Circular: *33],
        Verify: [Circular: *17],
        verify: <ref *52> ƒ verify(length: 4) {},
        createVerify: [Circular: *34],
        Hash: [Circular: *13],
        createHash: [Circular: *28],
        Hmac: [Circular: *14],
        createHmac: [Circular: *29],
        getHashes: <ref *53> ƒ getHashes(length: 0) {},
        randomInt: <ref *54> ƒ randomInt(length: 2) {},
        randomFill: <ref *55> ƒ randomFill(length: 4) {},
        randomFillSync: <ref *56> ƒ randomFillSync(length: 3) {},
        randomBytes: <ref *57> ƒ randomBytes(length: 2) {},
        randomUUID: <ref *58> ƒ randomUUID(length: 1) {},
        randomUUIDv7: <ref *59> ƒ randomUUIDv7(length: 1) {},
        argon2: [Circular: *19],
        argon2Sync: [Circular: *20],
        checkPrime: [Circular: *21],
        checkPrimeSync: [Circular: *22],
        generatePrime: <ref *60> ƒ generatePrime(length: 3) {},
        generatePrimeSync: <ref *61> ƒ generatePrimeSync(length: 2) {},
        secureHeapUsed: <ref *62> ƒ secureHeapUsed(length: 0) {},
        setEngine: <ref *63> ƒ setEngine(length: 2) {},
        getFips: <ref *64> ƒ getFips(length: 0) {},
        setFips: <ref *65> ƒ setFips(length: 1) {},
        DiffieHellmanGroup: [Circular: *10],
        createDiffieHellmanGroup: [Circular: *10],
        getDiffieHellman: [Circular: *10],
        createDiffieHellman: [Circular: *26],
        DiffieHellman: [Circular: *9],
        diffieHellman: <ref *66> ƒ diffieHellman(length: 2) {},
        ECDH: [Circular: *11],
        createECDH: [Circular: *27],
        Cipheriv: [Circular: *7],
        Decipheriv: [Circular: *8],
        createCipheriv: [Circular: *24],
        createDecipheriv: [Circular: *25],
        getCiphers: <ref *67> ƒ getCiphers(length: 0) {},
        scrypt: <ref *68> ƒ scrypt(length: 5) {},
        scryptSync: <ref *69> ƒ scryptSync(length: 4) {},
        publicEncrypt: <ref *70> ƒ publicEncrypt(length: 2) {},
        publicDecrypt: <ref *71> ƒ publicDecrypt(length: 2) {},
        privateEncrypt: <ref *72> ƒ privateEncrypt(length: 2) {},
        privateDecrypt: <ref *73> ƒ privateDecrypt(length: 2) {}
    },
    diffieHellman: [Circular: *66],
    generateKey: [Circular: *37],
    generateKeyPair: [Circular: *39],
    generateKeyPairSync: [Circular: *40],
    generateKeySync: [Circular: *38],
    generatePrime: [Circular: *60],
    generatePrimeSync: [Circular: *61],
    getCipherInfo: [Circular: *47],
    getCiphers: [Circular: *67],
    getCurves: [Circular: *46],
    getDiffieHellman: [Circular: *10],
    getFips: [Circular: *64],
    getHashes: [Circular: *53],
    getRandomValues: [Circular: *36],
    hash: [Circular: *41],
    hkdf: [Circular: *44],
    hkdfSync: [Circular: *45],
    pbkdf2: [Circular: *42],
    pbkdf2Sync: [Circular: *43],
    privateDecrypt: [Circular: *73],
    privateEncrypt: [Circular: *72],
    publicDecrypt: [Circular: *71],
    publicEncrypt: [Circular: *70],
    randomBytes: [Circular: *57],
    randomFill: [Circular: *55],
    randomFillSync: [Circular: *56],
    randomInt: [Circular: *54],
    randomUUID: [Circular: *58],
    randomUUIDv7: [Circular: *59],
    scrypt: [Circular: *68],
    scryptSync: [Circular: *69],
    secureHeapUsed: [Circular: *62],
    setEngine: [Circular: *63],
    setFips: [Circular: *65],
    sign: [Circular: *51],
    subtle: [Circular: *50],
    timingSafeEqual: [Circular: *48],
    verify: [Circular: *52],
    webcrypto: [Circular: *49]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        Resolver: [Circular: *2],
        getDefaultResultOrder: <ref *20> ƒ getDefaultResultOrder(length: 0) {},
        setDefaultResultOrder: <ref *21> ƒ setDefaultResultOrder(length: 1) {},
        getServers: <ref *22> ƒ getServers(length: 0) {},
        setServers: <ref *23> ƒ setServers(length: 1) {}
    },
    getDefaultResultOrder: [Circular: *20],
    getServers: [Circular: *22],
    lookup: [Circular: *4],
    lookupService: [Circular: *5],
    resolve: [Circular: *6],
    resolve4: [Circular: *7],
...
[Object: null prototype] {
    _stack: <ref *2> [],
    active: null,
    create: <ref *3> ƒ (length: 0) {},
    createDomain: [Circular: *3],
    default: {
        create: [Circular: *3],
        createDomain: [Circular: *3],
        _stack: [Circular: *2],
...
[Object: null prototype] {
    EventEmitter: <ref *2> ƒ EventEmitter(length: 1) {
        ...
        [get/set] captureRejections: false,
        [get/set] defaultMaxListeners: 10,
        once: <ref *17> async ƒ once(length: 2) {},
...
[Object: null prototype] {
    ...
    WriteStream: [Circular: *5],
    X_OK: 1,
    _toUnixTimestamp: <ref *8> ƒ _toUnixTimestamp(length: 1) {},
    access: <ref *9> ƒ access(length: 3) {},
    accessSync: <ref *10> ƒ accessSync(length: 2) {},
    appendFile: <ref *11> ƒ appendFile(length: 4) {},
    appendFileSync: <ref *12> ƒ appendFileSync(length: 3) {},
    ...
    default: {
        ...
        existsSync: <ref *29> ƒ existsSync(length: 1) {},
        fchown: <ref *30> ƒ fchown(length: 4) {},
        fchownSync: <ref *31> ƒ fchownSync(length: 3) {},
        fchmod: <ref *32> ƒ fchmod(length: 3) {},
        fchmodSync: <ref *33> ƒ fchmodSync(length: 2) {},
        fdatasync: <ref *34> ƒ fdatasync(length: 2) {},
        fdatasyncSync: <ref *35> ƒ fdatasyncSync(length: 1) {},
        fstat: <ref *36> ƒ fstat(length: 3) {},
        fstatSync: <ref *37> ƒ fstatSync(length: 1) {},
        fsync: <ref *38> ƒ fsync(length: 2) {},
        fsyncSync: <ref *39> ƒ fsyncSync(length: 1) {},
        ftruncate: <ref *40> ƒ ftruncate(length: 1) {},
        ftruncateSync: <ref *41> ƒ ftruncateSync(length: 1) {},
        futimes: <ref *42> ƒ futimes(length: 4) {},
        futimesSync: <ref *43> ƒ futimesSync(length: 3) {},
        glob: <ref *44> ƒ glob(length: 3) {},
        globSync: <ref *45> ƒ globSync(length: 2) {},
        lchown: <ref *46> ƒ lchown(length: 4) {},
        lchownSync: <ref *47> ƒ lchownSync(length: 3) {},
        lchmod: undefined,
        lchmodSync: undefined,
        link: <ref *48> ƒ link(length: 3) {},
        linkSync: <ref *49> ƒ linkSync(length: 2) {},
        lstat: <ref *50> ƒ lstat(length: 3) {},
        lstatSync: <ref *51> ƒ lstatSync(length: 1) {},
        lutimes: <ref *52> ƒ lutimes(length: 4) {},
        lutimesSync: <ref *53> ƒ lutimesSync(length: 3) {},
        mkdir: <ref *54> ƒ mkdir(length: 3) {},
        mkdirSync: <ref *55> ƒ mkdirSync(length: 2) {},
        mkdtemp: <ref *56> ƒ mkdtemp(length: 3) {},
        mkdtempSync: <ref *57> ƒ mkdtempSync(length: 2) {},
        mkdtempDisposableSync: <ref *58> ƒ mkdtempDisposableSync(length: 2) {},
        open: <ref *59> ƒ open(length: 4) {},
        openSync: <ref *60> ƒ openSync(length: 3) {},
        read: <ref *61> ƒ read(length: 6) {},
        readFile: <ref *62> ƒ readFile(length: 3) {},
        readFileSync: <ref *63> ƒ readFileSync(length: 2) {},
        readSync: <ref *64> ƒ readSync(length: 5) {},
        readdir: <ref *65> ƒ readdir(length: 3) {},
        readdirSync: <ref *66> ƒ readdirSync(length: 2) {},
        readlink: <ref *67> ƒ readlink(length: 3) {},
        readlinkSync: <ref *68> ƒ readlinkSync(length: 2) {},
        readv: <ref *69> ƒ readv(length: 4) {},
        readvSync: <ref *70> ƒ readvSync(length: 3) {},
        realpath: <ref *71> ƒ realpath(length: 3) {
        ...
        rmdir: <ref *79> ƒ rmdir(length: 3) {},
        rmdirSync: <ref *80> ƒ rmdirSync(length: 2) {},
        stat: <ref *81> ƒ stat(length: 3) {},
        statfs: <ref *82> ƒ statfs(length: 3) {},
        statSync: <ref *83> ƒ statSync(length: 1) {},
        statfsSync: <ref *84> ƒ statfsSync(length: 2) {},
        symlink: <ref *85> ƒ symlink(length: 4) {},
        symlinkSync: <ref *86> ƒ symlinkSync(length: 3) {},
        truncate: <ref *87> ƒ truncate(length: 3) {},
        truncateSync: <ref *88> ƒ truncateSync(length: 2) {},
        unlink: <ref *89> ƒ unlink(length: 2) {},
        unlinkSync: <ref *90> ƒ unlinkSync(length: 1) {},
        unwatchFile: <ref *91> ƒ unwatchFile(length: 2) {},
        utimes: <ref *92> ƒ utimes(length: 4) {},
        utimesSync: <ref *93> ƒ utimesSync(length: 3) {},
        watch: <ref *94> ƒ watch(length: 3) {},
        watchFile: <ref *95> ƒ watchFile(length: 3) {},
        write: <ref *96> ƒ write(length: 6) {},
        writeFile: <ref *97> ƒ writeFile(length: 4) {},
        writeFileSync: <ref *98> ƒ writeFileSync(length: 3) {},
        writeSync: <ref *99> ƒ writeSync(length: 5) {},
        writev: <ref *100> ƒ writev(length: 4) {},
        writevSync: <ref *101> ƒ writevSync(length: 3) {},
        _toUnixTimestamp: [Circular: *8],
        openAsBlob: <ref *102> ƒ openAsBlob(length: 2) {},
        Dirent: [Circular: *3],
        opendir: <ref *103> ƒ opendir(length: 3) {},
        opendirSync: <ref *104> ƒ opendirSync(length: 2) {},
        F_OK: 0,
        R_OK: 4,
        W_OK: 2,
        X_OK: 1,
        ...
        Utf8Stream: [Circular: *7],
        FileWriteStream: [Circular: *5],
        [get/set] promises: <ref *105> {
    ...
    fchmod: [Circular: *32],
    fchmodSync: [Circular: *33],
    fchown: [Circular: *30],
    fchownSync: [Circular: *31],
    fdatasync: [Circular: *34],
    fdatasyncSync: [Circular: *35],
    fstat: [Circular: *36],
    fstatSync: [Circular: *37],
    fsync: [Circular: *38],
    fsyncSync: [Circular: *39],
    ftruncate: [Circular: *40],
    ftruncateSync: [Circular: *41],
    futimes: [Circular: *42],
    futimesSync: [Circular: *43],
    glob: [Circular: *44],
    globSync: [Circular: *45],
    lchmod: undefined,
    lchmodSync: undefined,
    lchown: [Circular: *46],
    lchownSync: [Circular: *47],
    link: [Circular: *48],
    linkSync: [Circular: *49],
    lstat: [Circular: *50],
    lstatSync: [Circular: *51],
    lutimes: [Circular: *52],
    lutimesSync: [Circular: *53],
    mkdir: [Circular: *54],
    mkdirSync: [Circular: *55],
    mkdtemp: [Circular: *56],
    mkdtempDisposableSync: [Circular: *58],
    mkdtempSync: [Circular: *57],
    open: [Circular: *59],
    openAsBlob: [Circular: *102],
    openSync: [Circular: *60],
    opendir: [Circular: *103],
    opendirSync: [Circular: *104],
    promises: [Circular: *105],
    read: [Circular: *61],
    readFile: [Circular: *62],
    readFileSync: [Circular: *63],
    readSync: [Circular: *64],
    readdir: [Circular: *65],
    readdirSync: [Circular: *66],
    readlink: [Circular: *67],
    readlinkSync: [Circular: *68],
    readv: [Circular: *69],
    readvSync: [Circular: *70],
    realpath: [Circular: *71],
    realpathSync: [Circular: *73],
    rename: [Circular: *75],
    renameSync: [Circular: *76],
    ...
    truncateSync: [Circular: *88],
    unlink: [Circular: *89],
    unlinkSync: [Circular: *90],
    unwatchFile: [Circular: *91],
    utimes: [Circular: *92],
    utimesSync: [Circular: *93],
    watch: [Circular: *94],
    watchFile: [Circular: *95],
    write: [Circular: *96],
    writeFile: [Circular: *97],
    writeFileSync: [Circular: *98],
    writeSync: [Circular: *99],
    writev: [Circular: *100],
    writevSync: [Circular: *101]
}
...
[Object: null prototype] {
    ...
    default: {
        ...
        lchmod: <ref *20> async ƒ lchmod(length: 2) {},
        ...
        mkdtempDisposable: <ref *26> async ƒ mkdtempDisposable(length: 2) {},
        statfs: <ref *27> async ƒ statfs(length: 2) {},
        open: <ref *28> async ƒ open(length: 1) {},
        read: <ref *29> async ƒ read(length: 6) {},
        write: <ref *30> async ƒ write(length: 6) {},
        readdir: <ref *31> async ƒ readdir(length: 3) {},
        readFile: <ref *32> async ƒ readFile(length: 1) {},
        writeFile: <ref *33> async ƒ writeFile(length: 1) {},
        readlink: <ref *34> async ƒ readlink(length: 3) {},
        realpath: <ref *35> async ƒ realpath(length: 3) {},
        rename: <ref *36> async ƒ rename(length: 3) {},
        stat: <ref *37> async ƒ stat(length: 1) {},
        symlink: <ref *38> async ƒ symlink(length: 4) {},
        truncate: <ref *39> async ƒ truncate(length: 3) {},
        unlink: <ref *40> async ƒ unlink(length: 2) {},
        utimes: <ref *41> async ƒ utimes(length: 4) {},
        lutimes: <ref *42> async ƒ lutimes(length: 4) {},
        rm: <ref *43> async ƒ rm(length: 2) {},
        rmdir: <ref *44> async ƒ rmdir(length: 2) {},
        writev: <ref *45> async ƒ writev(length: 3) {},
        readv: <ref *46> async ƒ readv(length: 3) {},
        constants: [Circular: *7],
        watch: <ref *47> ƒ watch(length: 1) {},
        opendir: <ref *48> async ƒ opendir(length: 2) {}
    },
    exists: [Circular: *11],
    fchmod: [Circular: *12],
    fchown: [Circular: *13],
    ...
    mkdir: [Circular: *24],
    mkdtemp: [Circular: *25],
    mkdtempDisposable: [Circular: *26],
    open: [Circular: *28],
    opendir: [Circular: *48],
    read: [Circular: *29],
    readFile: [Circular: *32],
    readdir: [Circular: *31],
    readlink: [Circular: *34],
    readv: [Circular: *46],
    realpath: [Circular: *35],
    rename: [Circular: *36],
    rm: [Circular: *43],
    rmdir: [Circular: *44],
    stat: [Circular: *37],
...
[Object: null prototype] {
    ...
    MessageEvent: <ref *7> ƒ MessageEvent(length: 1) {},
    OutgoingMessage: <ref *8> ƒ OutgoingMessage(length: 1) {},
    STATUS_CODES: <ref *9> {
        100: "Continue",
        101: "Switching Protocols",
    ...
    Server: <ref *10> ƒ Server(length: 2) {},
    ServerResponse: <ref *11> ƒ ServerResponse(length: 2) {},
    WebSocket: <ref *12> ƒ WebSocket(length: 1) {
        CONNECTING: 0,
        OPEN: 1,
        CLOSING: 2,
        CLOSED: 3
    },
    createServer: <ref *13> ƒ createServer(length: 2) {},
    default: {
        Agent: [Circular: *2],
        Server: [Circular: *10],
        METHODS: [Circular: *6],
        STATUS_CODES: [Circular: *9],
        createServer: [Circular: *13],
        ServerResponse: [Circular: *11],
        IncomingMessage: [Circular: *5],
        request: <ref *15> ƒ request(length: 3) {},
        get: <ref *16> ƒ get(length: 3) {},
        [get/set] maxHeaderSize: 16384,
        validateHeaderName: <ref *17> ƒ validateHeaderName(length: 2) {},
        validateHeaderValue: <ref *18> ƒ validateHeaderValue(length: 2) {},
        setMaxIdleHTTPParsers: <ref *19> ƒ setMaxIdleHTTPParsers(length: 1) {},
        setGlobalProxyFromEnv: <ref *20> ƒ setGlobalProxyFromEnv(length: 0) {},
        [get/set] globalAgent: <ref *21> Agent {
            _events: [Object: null prototype] {
                free: ƒ (length: 2) {},
                newListener: ƒ maybeEnableKeylog(length: 1) {}
            },
        ...
        ClientRequest: [Circular: *3],
        OutgoingMessage: [Circular: *8],
        WebSocket: [Circular: *12],
        CloseEvent: [Circular: *4],
        MessageEvent: [Circular: *7]
    },
    get: [Circular: *16],
    globalAgent: [Circular: *21],
    maxHeaderSize: 16384,
    request: [Circular: *15],
    setGlobalProxyFromEnv: [Circular: *20],
    setMaxIdleHTTPParsers: [Circular: *19],
    validateHeaderName: [Circular: *17],
    validateHeaderValue: [Circular: *18]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        getUnpackedSettings: <ref *12> ƒ getUnpackedSettings(length: 2) {},
        performServerHandshake: <ref *13> ƒ performServerHandshake(length: 1) {},
        ...
        Symbol(::bunhttp2internals::): {
            core: {
                ...
                ClientHttp2Stream: class ClientHttp2Stream extends Http2Stream {}
            },
            util: {
                assertIsObject: ƒ ::bunternal::(length: 3) {},
                assertIsArray: ƒ ::bunternal::(length: 3) {},
                assertWithinRange: ƒ assertWithinRange(length: 2) {},
                assertValidPseudoHeader: ƒ ::bunternal::(length: 1) {},
                sessionName: ƒ sessionName(length: 1) {},
                NghttpError: class NghttpError extends Error {}
            }
        }
    },
    ...
    performServerHandshake: [Circular: *13],
    sensitiveHeaders: Symbol(nodejs.http2.sensitiveHeaders)
}
```
...
[Object: null prototype] {
    ...
    default: {
        console: [Circular: *4],
        open: <ref *52> ƒ ::bunternal::(length: 3) {},
        close: [Circular: *3],
...
```js
[Object: null prototype] {
    Session: <ref *2> class Session extends BaseSession {},
    close: <ref *3> ƒ ::bunternal::(length: 0) {},
    console: <ref *4> {
        debug: <ref *5> ƒ debug(length: 0) {},
        error: <ref *6> ƒ error(length: 0) {},
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1788136197911-1/module.mjs: "/tmp/fs-fixture-1788136197911-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            ...
            "/opt/hostedtoolcache/node/24.19.0/x64/lib/node"
        ],
        ...
        getCompileCacheDir: <ref *30> ƒ getCompileCacheDir(length: 0) {},
    ...
    getCompileCacheDir: [Circular: *30],
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 1) {
        _cache: <ref *3> {
            /tmp/fs-fixture-1788136197911-1/inspect.mjs: {
        ...
        _debug: <ref *7> {},
        _extensions: <ref *8> [Object: null prototype] {
            .js: <ref *9> ƒ (length: 2) {},
            .json: ƒ (length: 2) {},
            .node: ƒ (length: 2) {},
            .ts: <ref *12> ƒ (length: 2) {},
            .cts: [Circular: *12],
            .mjs: [Circular: *9],
            .mts: [Circular: *12]
        },
        _findPath: <ref *13> ƒ _findPath(length: 3) {},
        _initPaths: <ref *14> ƒ (length: 0) {},
        _load: <ref *15> ƒ _load(length: 1) {},
        _nodeModulePaths: <ref *16> ƒ _nodeModulePaths(length: 1) {},
        _pathCache: <ref *17> [Object: null prototype] {},
        _preloadModules: <ref *18> ƒ _preloadModules(length: 0) {},
        [get/set] _resolveFilename: <ref *19> ƒ _resolveFilename(length: 2) {},
        _resolveLookupPaths: <ref *20> ƒ _resolveLookupPaths(length: 2) {},
        _stat: <ref *21> ƒ _stat(length: 1) {},
        builtinModules: <ref *22> [
            "_http_agent",
            "_http_client",
            "_http_common",
        ...
        findSourceMap: <ref *27> ƒ findSourceMap(length: 1) {},
        flushCompileCache: <ref *28> ƒ flushCompileCache(length: 0) {},
        getCompileCacheDir: <ref *29> ƒ getCompileCacheDir(length: 0) {},
        globalPaths: <ref *30> [],
        isBuiltin: <ref *31> ƒ isBuiltin(length: 1) {},
        register: <ref *32> ƒ register(length: 1) {},
        [get/set] runMain: <ref *33> ƒ runMain(length: 2) {},
        SourceMap: <ref *34> ƒ SourceMap(length: 0) {},
        syncBuiltinESMExports: <ref *35> ƒ syncBuiltinESMExports(length: 0) {},
        wrap: <ref *36> ƒ wrap(length: 1) {},
        [get/set] wrapper: [
    ...
    SourceMap: [Circular: *34],
    _cache: [Circular: *3],
    _debug: [Circular: *7],
    _extensions: [Circular: *8],
    _findPath: [Circular: *13],
    _initPaths: [Circular: *14],
    _load: [Circular: *15],
    _nodeModulePaths: [Circular: *16],
    _pathCache: [Circular: *17],
    _preloadModules: [Circular: *18],
    _resolveFilename: [Circular: *19],
    _resolveLookupPaths: [Circular: *20],
    _stat: [Circular: *21],
    builtinModules: [Circular: *22],
    constants: [Circular: *23],
    ...
    globalPaths: [Circular: *30],
    isBuiltin: [Circular: *31],
    register: [Circular: *32],
    runMain: [Circular: *33],
    syncBuiltinESMExports: [Circular: *35],
    wrap: [Circular: *36],
    wrapper: [
        "(function(exports,require,module,__filename,__dirname){",
        "})"
...
[Object: null prototype] {
    ...
    PerformanceObserver: <ref *7> class PerformanceObserverForNodeTypes extends NodePerformanceObserver {},
    PerformanceObserverEntryList: <ref *8> ƒ PerformanceObserverEntryList(length: 0) {},
    PerformanceResourceTiming: <ref *9> ƒ PerformanceResourceTiming(length: 0) {},
    constants: <ref *10> {
    ...
    createHistogram: <ref *11> ƒ createHistogram(length: 0) {},
    default: {
        ...
        PerformanceObserverEntryList: [Circular: *8],
        PerformanceNodeTiming: [Circular: *6],
        eventLoopUtilization: <ref *16> ƒ eventLoopUtilization(length: 2) {},
        monitorEventLoopDelay: <ref *17> ƒ monitorEventLoopDelay(length: 1) {},
        createHistogram: [Circular: *11],
        PerformanceResourceTiming: [Circular: *9]
    },
    eventLoopUtilization: [Circular: *16],
    monitorEventLoopDelay: [Circular: *17],
    performance: [Circular: *14],
    timerify: [Circular: *13]
}
```
...
[Object: null prototype] {
    ...
    argv: <ref *26> [
        ...
        "/tmp/fs-fixture-1788136197911-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        release: <ref *50> {
            name: "node",
            lts: "Krypton",
            sourceUrl: "https://nodejs.org/download/release/v24.19.0/node-v24.19.0.tar.gz",
            headersUrl: "https://nodejs.org/download/release/v24.19.0/node-v24.19.0-headers.tar.gz"
        },
        ...
        threadCpuUsage: <ref *57> ƒ threadCpuUsage(length: 1) {},
        ...
        execve: <ref *63> ƒ execve(length: 1) {},
        ...
        env: <ref *120>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_13c8b102-09d4-4b01-8648-05db5785802c",
            npm_package_devDependencies__types_node: "^18.15.11",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            npm_config_user_agent: "pnpm/9.12.1 npm/? node/v24.19.0 linux x64",
            CI: "true",
            USE_BAZEL_FALLBACK_VERSION: "silent:",
            RUNNER_ENVIRONMENT: "github-hosted",
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_13c8b102-09d4-4b01-8648-05db5785802c",
            PIPX_HOME: "/opt/pipx",
            npm_node_execpath: "/opt/hostedtoolcache/node/24.19.0/x64/bin/node",
            ...
            ACTIONS_ORCHESTRATION_ID: "d898bcf2-a2f0-4f5b-9ac3-8d68f1ca974e.build.__default",
            ...
            GITHUB_ARTIFACTS: "/home/runner/work/_temp/_runner_file_commands/artifacts_13c8b102-09d4-4b01-8648-05db5785802c",
            SWIFT_PATH: "/usr/share/swift/usr/bin",
            npm_package_devDependencies_lintroll: "^1.10.0",
            CHROMEWEBDRIVER: "/usr/local/share/chromedriver-linux64",
            JOURNAL_STREAM: "9:13027",
            ...
            GITHUB_RUN_ID: "33344735842",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "0668d73a211aa13f358249200c42a4ce4bf6d863",
            ...
            RUNNER_TRACKING_ID: "github_a5c0acdf-2762-404d-ba0c-fbe0c373725b",
            INVOCATION_ID: "cc91cafcb57b42b593c848fab2ec22c0",
            RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            NODE: "/opt/hostedtoolcache/node/24.19.0/x64/bin/node",
            GITHUB_ACTION: "__run",
            ...
            RUNNER_NAME: "GitHub Actions 1000018004",
            ...
            GITHUB_SHA: "0668d73a211aa13f358249200c42a4ce4bf6d863",
            ...
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_13c8b102-09d4-4b01-8648-05db5785802c",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_13c8b102-09d4-4b01-8648-05db5785802c",
            EDGEWEBDRIVER: "/usr/local/share/edge_driver",
            npm_command: "run-script",
            PNPM_SCRIPT_SRC_DIR: "/home/runner/work/compare-bun-node/compare-bun-node",
            ANDROID_NDK: "/usr/local/lib/android/sdk/ndk/27.3.13750724",
            GITHUB_ARTIFACTS_LIST: "/home/runner/work/_temp/_runner_file_commands/artifacts_list_13c8b102-09d4-4b01-8648-05db5785802c",
            SGX_AESM_ADDR: "1",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_13c8b102-09d4-4b01-8648-05db5785802c",
        ...
        pid: 3003,
        ppid: 2444,
        execPath: "/opt/hostedtoolcache/node/24.19.0/x64/bin/node",
        debugPort: 9229,
        argv0: "node",
...
[Object: null prototype] {
    ...
    allowedNodeEnvironmentFlags: <ref *16> NodeEnvironmentFlagsSet {},
    arch: "x64",
    argv: <ref *17> [
    ...
    default: EventEmitter {
        ...
        threadCpuUsage: <ref *35> ƒ threadCpuUsage(length: 1) {},
        cwd: [Circular: *28],
        ...
        execve: <ref *40> ƒ execve(length: 3) {},
        exit: <ref *41> ƒ exit(length: 1) {},
        [get/set] exitCode: undefined,
        ...
        getActiveResourcesInfo: <ref *43> ƒ getActiveResourcesInfo(length: 0) {},
        getBuiltinModule: <ref *44> ƒ getBuiltinModule(length: 1) {},
        hasUncaughtExceptionCaptureCallback: <ref *45> ƒ hasUncaughtExceptionCaptureCallback(length: 0) {},
        hrtime: <ref *46> ƒ hrtime(length: 0) {
            bigint: ƒ bigint(length: 0) {}
        },
        isBun: true,
        kill: <ref *48> ƒ kill(length: 2) {},
        ...
        release: <ref *56> {
            name: "node",
            sourceUrl: "https://github.com/oven-sh/bun/releases/download/bun-v1.4.1/bun-linux-x64.zip",
            headersUrl: "https://nodejs.org/download/release/v26.3.0/node-v26.3.0-headers.tar.gz"
        },
        report: <ref *57> {
            compact: false,
            directory: "",
        ...
        revision: "16a30126f67f5f2405f89b43b4bec5f0c19517a6",
        send: undefined,
        ...
        stderr: <ref *63> WriteStream {
            ...
            Symbol(kFs): <ref *72> {
                ...
                mkdtempDisposableSync: ƒ mkdtempDisposableSync(length: 2) {},
                ...
                W_OK: 2,
                X_OK: 1,
                constants: <ref *169> [Object: null prototype] {
                    UV_FS_SYMLINK_DIR: 1,
                    UV_FS_SYMLINK_JUNCTION: 2,
                    O_RDONLY: 0,
                    O_WRONLY: 1,
                ...
                [get/set] ReadStream: <ref *172> ƒ ReadStream(length: 2) {},
                WriteStream: <ref *173> ƒ WriteStream(length: 2) {},
                [get/set] FileReadStream: [Circular: *172],
                [get/set] Utf8Stream: class Utf8Stream extends EventEmitter {},
                [get/set] FileWriteStream: [Circular: *173],
                [get/set] promises: {
                    access: async ƒ access(length: 3) {},
                    appendFile: async ƒ appendFile(length: 1) {},
                    close: async ƒ close(length: 1) {},
        ...
        stdin: <ref *223> ReadStream {
            ...
            _events: {
                ...
                resume: ƒ (length: 0) {},
                pause: ƒ (length: 0) {},
                Symbol(kConstruct): ƒ onceWrapper(length: 0) {
                    listener: ƒ (length: 0) {}
                }
            },
            _readableState: {
            ...
            _maxListeners: undefined,
            _eventsCount: 5,
            on: <ref *234> ƒ (length: 2) {},
            addListener: [Circular: *234],
            ref: ƒ (length: 0) {},
            unref: ƒ (length: 0) {},
            pause: ƒ (length: 0) {},
            resume: ƒ (length: 0) {},
        ...
        versions: <ref *252> {
            ...
            uwebsockets: "16a30126f67f5f2405f89b43b4bec5f0c19517a6",
            webkit: "d71031a973e6f8838a1b10282dbe332ff012f04a",
            ...
            usockets: "16a30126f67f5f2405f89b43b4bec5f0c19517a6",
    ...
    dlopen: [Circular: *36],
    emit: ƒ emit(length: 1) {},
    emitWarning: [Circular: *37],
    env: [Circular: *38],
    eventNames: ƒ eventNames(length: 0) {},
    execArgv: [Circular: *39],
    execPath: "/home/runner/.bun/bin/bun",
    execve: [Circular: *40],
    exit: [Circular: *41],
    exitCode: undefined,
    features: [Circular: *42],
    finalization: [Circular: *31],
    ...
    listeners: ƒ listeners(length: 1) {},
    loadEnvFile: [Circular: *30],
    mainModule: undefined,
    memoryUsage: [Circular: *49],
    moduleLoadList: [Circular: *51],
    nextTick: [Circular: *52],
    off: ƒ off(length: 2) {},
    on: ƒ on(length: 2) {},
    once: ƒ once(length: 2) {},
...
(node:3020) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        REPL_MODE_SLOPPY: Symbol(repl-sloppy),
        REPL_MODE_STRICT: Symbol(repl-strict),
        isValidSyntax: <ref *6> ƒ isValidSyntax(length: 0) {},
        [get/set] REPLServer: [Circular: *2],
        [get/set] writer: <ref *7> ƒ writer(length: 1) {
            options: {
                showHidden: false,
                depth: 2,
                colors: false,
        ...
        [get/set] repl: undefined
    },
    isValidSyntax: [Circular: *6],
    repl: undefined,
    start: [Circular: *5],
    writer: [Circular: *7]
}
...
[Object: null prototype] {
    ...
    CompressionStream: <ref *3> ƒ CompressionStream(length: 1) {},
    CountQueuingStrategy: <ref *4> ƒ CountQueuingStrategy(length: 1) {},
    DecompressionStream: <ref *5> ƒ DecompressionStream(length: 1) {},
    ReadableByteStreamController: <ref *6> ƒ ReadableByteStreamController(length: 0) {},
    ReadableStream: <ref *7> ƒ ReadableStream(length: 0) {
        from: ƒ from(length: 1) {}
    },
    ReadableStreamBYOBReader: <ref *9> ƒ ReadableStreamBYOBReader(length: 1) {},
    ReadableStreamBYOBRequest: <ref *10> ƒ ReadableStreamBYOBRequest(length: 0) {},
    ReadableStreamDefaultController: <ref *11> ƒ ReadableStreamDefaultController(length: 0) {},
    ReadableStreamDefaultReader: <ref *12> ƒ ReadableStreamDefaultReader(length: 1) {},
    TextDecoderStream: <ref *13> ƒ TextDecoderStream(length: 0) {},
    TextEncoderStream: <ref *14> ƒ TextEncoderStream(length: 0) {},
    TransformStream: <ref *15> ƒ TransformStream(length: 0) {},
    TransformStreamDefaultController: <ref *16> ƒ TransformStreamDefaultController(length: 0) {},
    WritableStream: <ref *17> ƒ WritableStream(length: 0) {},
    WritableStreamDefaultController: <ref *18> ƒ WritableStreamDefaultController(length: 0) {},
    WritableStreamDefaultWriter: <ref *19> ƒ WritableStreamDefaultWriter(length: 1) {},
    default: {
        ReadableStream: [Circular: *7],
        ReadableStreamDefaultReader: [Circular: *12],
        ReadableStreamBYOBReader: [Circular: *9],
...
[Object: null prototype] {
    ...
    default: {
        ...
        isDeepStrictEqual: <ref *71> ƒ isDeepStrictEqual(length: 3) {},
        ...
        parseEnv: <ref *121> ƒ parseEnv(length: 1) {},
        parseArgs: <ref *122> ƒ parseArgs(length: 0) {},
        TextDecoder: [Circular: *4],
        TextEncoder: [Circular: *5],
        MIMEType: [Circular: *3],
        MIMEParams: [Circular: *2],
        diff: <ref *123> ƒ diff(length: 2) {},
        setTraceSigInt: <ref *124> ƒ setTraceSigInt(length: 1) {}
    },
    ...
    parseArgs: [Circular: *122],
    parseEnv: [Circular: *121],
    promisify: [Circular: *72],
    setTraceSigInt: [Circular: *124],
...
(node:3158) [DEP0025] DeprecationWarning: sys is deprecated. Use util instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
[Object: null prototype] {
    ...
    _errnoException: <ref *6> ƒ _errnoException(length: 3) {},
    _extend: <ref *7> ƒ _extend(length: 2) {},
    aborted: <ref *8> ƒ aborted(length: 2) {},
    callbackify: <ref *9> ƒ callbackify(length: 1) {},
    convertProcessSignalToExitCode: <ref *10> ƒ convertProcessSignalToExitCode(length: 1) {},
    debug: <ref *11> ƒ debuglog(length: 1) {},
    debuglog: [Circular: *11],
    default: {
        _errnoException: [Circular: *6],
        _extend: [Circular: *7],
        callbackify: [Circular: *9],
        convertProcessSignalToExitCode: [Circular: *10],
        debug: [Circular: *11],
        debuglog: [Circular: *11],
        deprecate: <ref *13> ƒ deprecate(length: 3) {},
        [get/set] format: <ref *14> ƒ format(length: 0) {},
        styleText: <ref *15> ƒ styleText(length: 3) {},
        [get/set] formatWithOptions: <ref *16> ƒ formatWithOptions(length: 1) {},
        ...
        inherits: <ref *21> ƒ inherits2(length: 2) {},
        [get/set] inspect: <ref *22> ƒ inspect(length: 2) {
            custom: Symbol(nodejs.util.inspect.custom),
            colors: [Object: null prototype] {
                reset: [
                    0,
        ...
        isDeepStrictEqual: <ref *71> ƒ jsFunctionIsDeepStrictEqual(length: 3) {},
        promisify: <ref *72> ƒ promisify2(length: 1) {
            custom: Symbol(nodejs.util.promisify.custom)
        },
        setTraceSigInt: <ref *73> ƒ setTraceSigInt(length: 1) {},
        [get/set] stripVTControlCharacters: <ref *74> ƒ stripVTControlCharacters(length: 1) {},
        toUSVString: <ref *75> ƒ toUSVString(length: 1) {},
        aborted: [Circular: *8],
        types: <ref *76> {
            isExternal: ƒ isExternal(length: 1) {},
            isDate: <ref *78> ƒ isDate(length: 1) {},
            ...
            isRegExp: <ref *86> ƒ isRegExp(length: 1) {},
        ...
        parseEnv: <ref *121> ƒ parseEnv(length: 1) {},
        parseArgs: <ref *122> ƒ parseArgs(length: 1) {},
        TextDecoder: [Circular: *4],
        TextEncoder: [Circular: *5],
        MIMEType: [Circular: *3],
        MIMEParams: [Circular: *2],
        isArray: <ref *123> ƒ isArray(length: 1) {},
        isBoolean: <ref *124> ƒ isBoolean(length: 1) {},
        isBuffer: <ref *125> ƒ isBuffer(length: 1) {},
        isNull: <ref *126> ƒ isNull(length: 1) {},
        isNullOrUndefined: <ref *127> ƒ isNullOrUndefined(length: 1) {},
        isNumber: <ref *128> ƒ isNumber(length: 1) {},
        isString: <ref *129> ƒ isString(length: 1) {},
        isSymbol: <ref *130> ƒ isSymbol(length: 1) {},
        isUndefined: <ref *131> ƒ isUndefined(length: 1) {},
        isRegExp: [Circular: *86],
        isObject: <ref *132> ƒ isObject(length: 1) {},
        isDate: [Circular: *78],
        isError: <ref *133> ƒ jsFunctionIsError(length: 1) {},
        isFunction: <ref *134> ƒ isFunction(length: 1) {},
        isPrimitive: <ref *135> ƒ isPrimitive(length: 1) {},
        log: <ref *136> ƒ log2(length: 0) {}
    },
    ...
    inspect: [Circular: *22],
    isArray: [Circular: *123],
    isBoolean: [Circular: *124],
    isBuffer: [Circular: *125],
    isDate: [Circular: *78],
    isDeepStrictEqual: [Circular: *71],
    isError: [Circular: *133],
    isFunction: [Circular: *134],
    isNull: [Circular: *126],
    isNullOrUndefined: [Circular: *127],
    isNumber: [Circular: *128],
    isObject: [Circular: *132],
    isPrimitive: [Circular: *135],
    isRegExp: [Circular: *86],
    isString: [Circular: *129],
    isSymbol: [Circular: *130],
    isUndefined: [Circular: *131],
    log: [Circular: *136],
    parseArgs: [Circular: *122],
    parseEnv: [Circular: *121],
    promisify: [Circular: *72],
    setTraceSigInt: [Circular: *73],
...
[Object: null prototype] {
    ...
    default: {
        setTimeout: <ref *7> ƒ setTimeout(length: 1) {
            [get/set] Symbol(nodejs.util.promisify.custom): <ref *8> ƒ setTimeout(length: 0) {}
        },
        clearTimeout: [Circular: *5],
        setInterval: <ref *9> ƒ setInterval(length: 1) {
            [get/set] Symbol(nodejs.util.promisify.custom): <ref *10> ƒ setInterval(length: 0) {}
        },
        setImmediate: <ref *11> ƒ setImmediate(length: 1) {
            [get/set] Symbol(nodejs.util.promisify.custom): <ref *12> ƒ setImmediate(length: 1) {}
        },
        clearInterval: [Circular: *4],
        clearImmediate: [Circular: *3],
        [get/set] promises: <ref *13> {
            setTimeout: [Circular: *8],
            setImmediate: [Circular: *12],
            setInterval: [Circular: *10],
            scheduler: {
    ...
    enroll: [Circular: *17],
    promises: [Circular: *13],
    setImmediate: [Circular: *11],
    setInterval: [Circular: *9],
    setTimeout: [Circular: *7],
...
[Object: null prototype] {
    ...
    default: {
        ...
        getCACertificates: <ref *15> ƒ getCACertificates(length: 0) {}
    },
    getCACertificates: [Circular: *15],
    getCiphers: [Circular: *11],
    parseCertString: [Circular: *13],
    rootCertificates: [Circular: *14],
    setDefaultCACertificates: [Circular: *12]
}
```
...
[Object: null prototype] {
    ...
    URLPattern: <ref *7> ƒ URLPattern(length: 0) {},
    URLSearchParams: <ref *8> ƒ URLSearchParams(length: 0) {},
    Url: <ref *9> ƒ Url(length: 0) {
        prototype: {
    ...
    default: {
        parse: <ref *17> ƒ urlParse(length: 3) {},
        resolve: <ref *18> ƒ urlResolve(length: 2) {},
        resolveObject: <ref *19> ƒ urlResolveObject(length: 2) {},
        format: <ref *20> ƒ urlFormat(length: 2) {},
        Url: [Circular: *9],
        URLSearchParams: [Circular: *8],
        URL: [Circular: *2],
        URLPattern: [Circular: *7],
        pathToFileURL: <ref *21> ƒ pathToFileURL(length: 2) {},
        fileURLToPath: <ref *22> ƒ fileURLToPath(length: 2) {},
        fileURLToPathBuffer: <ref *23> ƒ fileURLToPathBuffer(length: 2) {},
        urlToHttpOptions: <ref *24> ƒ urlToHttpOptions(length: 1) {},
        domainToASCII: <ref *25> ƒ domainToAscii(length: 1) {},
        domainToUnicode: <ref *26> ƒ domainToUnicode(length: 1) {}
    },
    domainToASCII: [Circular: *25],
    domainToUnicode: [Circular: *26],
    fileURLToPath: [Circular: *22],
    fileURLToPathBuffer: [Circular: *23],
    format: [Circular: *20],
    parse: [Circular: *17],
    pathToFileURL: [Circular: *21],
    resolve: [Circular: *18],
    resolveObject: [Circular: *19],
    urlToHttpOptions: [Circular: *24]
}
```
...
[Object: null prototype] {
    ...
    default: {
        cachedDataVersionTag: [Circular: *7],
        GCProfiler: [Circular: *5],
        isStringOneByteRepresentation: <ref *9> ƒ isStringOneByteRepresentation(length: 1) {},
        getHeapSnapshot: <ref *10> ƒ ::bunternal::(length: 0) {},
        getHeapStatistics: <ref *11> ƒ ::bunternal::(length: 0) {},
        getHeapSpaceStatistics: <ref *12> ƒ ::bunternal::(length: 0) {},
        getHeapCodeStatistics: <ref *13> ƒ ::bunternal::(length: 0) {},
        getCppHeapStatistics: <ref *14> ƒ ::bunternal::(length: 0) {},
        setFlagsFromString: <ref *15> ƒ ::bunternal::(length: 1) {},
        deserialize: <ref *16> ƒ ::bunternal::(length: 1) {},
        takeCoverage: <ref *17> ƒ ::bunternal::(length: 0) {},
        stopCoverage: <ref *18> ƒ ::bunternal::(length: 0) {},
        serialize: <ref *19> ƒ ::bunternal::(length: 1) {},
        writeHeapSnapshot: <ref *20> ƒ ::bunternal::(length: 2) {},
        setHeapSnapshotNearHeapLimit: <ref *21> ƒ ::bunternal::(length: 0) {},
        promiseHooks: <ref *22> {
            createHook: ƒ createHook(length: 0) {},
        ...
        startupSnapshot: <ref *28> {
            addDeserializeCallback: <ref *29> ƒ ::bunternal::(length: 0) {},
            addSerializeCallback: [Circular: *29],
            setDeserializeMainFunction: [Circular: *29],
            isBuildingSnapshot: ƒ isBuildingSnapshot(length: 0) {}
        },
        Deserializer: [Circular: *4],
        Serializer: [Circular: *6],
    ...
    deserialize: [Circular: *16],
    getCppHeapStatistics: [Circular: *14],
    getHeapCodeStatistics: [Circular: *13],
    getHeapSnapshot: [Circular: *10],
    getHeapSpaceStatistics: [Circular: *12],
    getHeapStatistics: [Circular: *11],
    isStringOneByteRepresentation: [Circular: *9],
    promiseHooks: [Circular: *22],
    serialize: [Circular: *19],
    setFlagsFromString: [Circular: *15],
    setHeapSnapshotNearHeapLimit: [Circular: *21],
    startupSnapshot: [Circular: *28],
    stopCoverage: [Circular: *18],
    takeCoverage: [Circular: *17],
    writeHeapSnapshot: [Circular: *20]
}
```
...
[Object: null prototype] {
    ...
    createContext: <ref *8> ƒ createContext(length: 2) {},
...
(node:3301) ExperimentalWarning: WASI is an experimental feature and might change at any time
...
error: Could not resolve: "node:sea". Maybe you need to "bun install"?
    at /tmp/fs-fixture-1788136197911-1/node:sea.mjs:2:25

Bun v1.4.1-canary.1+16a30126f (Linux x64)
```
...
```js
[Object: null prototype] {
    DatabaseSync: <ref *2> ƒ DatabaseSync(length: 1) {},
    Session: <ref *3> ƒ Session(length: 0) {},
    StatementSync: <ref *4> ƒ StatementSync(length: 0) {},
    backup: <ref *5> ƒ backup(length: 2) {},
    constants: <ref *6> [Object: null prototype] {
...
[Object: null prototype] {
    ...
    assert: <ref *4> {
        ...
        equal: <ref *7> ƒ equal(length: 3) {},
        notEqual: <ref *8> ƒ notEqual(length: 3) {},
        deepEqual: <ref *9> ƒ deepEqual(length: 3) {},
        notDeepEqual: <ref *10> ƒ notDeepEqual(length: 3) {},
        deepStrictEqual: <ref *11> ƒ deepStrictEqual(length: 3) {},
        notDeepStrictEqual: <ref *12> ƒ notDeepStrictEqual(length: 3) {},
        strictEqual: <ref *13> ƒ strictEqual(length: 3) {},
        notStrictEqual: <ref *14> ƒ notStrictEqual(length: 3) {},
        partialDeepStrictEqual: <ref *15> ƒ partialDeepStrictEqual(length: 3) {},
        ...
        fileSnapshot: ƒ fileSnapshot(length: 2) {},
        snapshot: ƒ snapshot(length: 1) {},
        register: ƒ registerCustomAssertion(length: 2) {}
    },
    before: <ref *28> ƒ before(length: 2) {},
    beforeEach: <ref *29> ƒ beforeEach(length: 2) {},
    default: <ref *30> ƒ test(length: 3) {
        skip: <ref *31> ƒ (length: 3) {},
        todo: <ref *32> ƒ (length: 3) {},
        only: <ref *33> ƒ (length: 3) {},
        describe: <ref *34> ƒ describe(length: 3) {
            skip: ƒ (length: 3) {},
            todo: ƒ (length: 3) {},
            only: ƒ (length: 3) {}
        },
        ...
        before: [Circular: *28],
        after: [Circular: *2],
        beforeEach: [Circular: *29],
        afterEach: [Circular: *3],
        assert: [Circular: *4],
        snapshot: <ref *38> {
            setDefaultSnapshotSerializer: ƒ setDefaultSnapshotSerializer(length: 1) {},
            setResolveSnapshotPath: ƒ setResolveSnapshotPath(length: 1) {}
        },
        run: <ref *41> ƒ run(length: 0) {},
        mock: <ref *42> MockTracker {},
        getTestContext: <ref *43> ƒ getTestContext(length: 0) {}
    },
    describe: [Circular: *34],
    getTestContext: [Circular: *43],
    it: [Circular: *30],
    mock: [Circular: *42],
    only: [Circular: *33],
    run: [Circular: *41],
    skip: [Circular: *31],
    snapshot: [Circular: *38],
    suite: [Circular: *34],
    test: [Circular: *30],
    todo: [Circular: *32]
}
...
error: Could not resolve: "node:test/reporters". Maybe you need to "bun install"?
    at /tmp/fs-fixture-1788136197911-1/node:test_reporters.mjs:2:25
