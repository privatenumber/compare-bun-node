...
_Last updated on <!-- lastUpdated:start -->Jun 29, 2026 with Bun 1.4.0 Node.js v24.17.0<!-- lastUpdated:end -->._
...
[Object: null prototype] {
    ...
    default: {
        ...
        shouldUseEnvProxy: <ref *14> ƒ shouldUseEnvProxy(length: 0) {}
    },
    globalAgent: [Circular: *4],
    shouldUseEnvProxy: [Circular: *14]
}
```
...
[Object: null prototype] {
    ...
    continueExpression: <ref *6> /(?:^|\W)100-continue(?:$|\W)/i,
    default: {
        validateHeaderName: <ref *8> ƒ validateHeaderName(length: 2) {},
        validateHeaderValue: <ref *9> ƒ validateHeaderValue(length: 2) {},
        _checkIsHttpToken: [Circular: *4],
        _checkInvalidHeaderChar: [Circular: *3],
        chunkExpression: [Circular: *5],
        continueExpression: [Circular: *6],
        CRLF: "\r\n",
        freeParser: <ref *10> ƒ freeParser(length: 3) {},
        methods: <ref *11> [
            "DELETE",
            "GET",
            "HEAD",
        ...
        kSkipPendingData: Symbol(SkipPendingData),
        HTTPParser: [Circular: *2],
        isLenient: <ref *15> ƒ isLenient(length: 0) {},
        prepareError: <ref *16> ƒ prepareError(length: 3) {}
    },
    freeParser: [Circular: *10],
    isLenient: [Circular: *15],
    kIncomingMessage: Symbol(IncomingMessage),
    kSkipPendingData: Symbol(SkipPendingData),
    methods: [Circular: *11],
    parsers: [Circular: *12],
    prepareError: [Circular: *16],
    validateHeaderName: [Circular: *8],
    validateHeaderValue: [Circular: *9]
}
```
...
(node:2556) [DEP0125] DeprecationWarning: The _stream_wrap module is deprecated.
...
[Object: null prototype] {
    ...
    default: {
        ...
        mkdtemp: <ref *55> ƒ mkdtemp(length: 3) {},
        mkdtempSync: <ref *56> ƒ mkdtempSync(length: 2) {},
        mkdtempDisposableSync: <ref *57> ƒ mkdtempDisposableSync2(length: 2) {},
        open: <ref *58> ƒ open(length: 4) {},
        openSync: <ref *59> ƒ openSync(length: 3) {},
        read: <ref *60> ƒ read(length: 6) {},
        readFile: <ref *61> ƒ readFile(length: 3) {},
        readFileSync: <ref *62> ƒ readFileSync(length: 2) {},
        readSync: <ref *63> ƒ readSync(length: 5) {},
        readdir: <ref *64> ƒ readdir(length: 3) {},
        readdirSync: <ref *65> ƒ readdirSync(length: 2) {},
        readlink: <ref *66> ƒ readlink(length: 3) {},
        readlinkSync: <ref *67> ƒ readlinkSync(length: 2) {},
        readv: <ref *68> ƒ readv(length: 4) {},
        readvSync: <ref *69> ƒ readvSync(length: 3) {},
        realpath: <ref *70> ƒ realpath(length: 3) {
            native: ƒ realpath4(length: 3) {}
        },
        realpathSync: <ref *72> ƒ realpathSync(length: 2) {
            native: ƒ bound realpathNativeSync(length: 3) {}
        },
        rename: <ref *74> ƒ rename(length: 3) {},
        renameSync: <ref *75> ƒ renameSync(length: 2) {},
        rm: <ref *76> ƒ rm(length: 3) {},
        rmSync: <ref *77> ƒ rmSync(length: 2) {},
        rmdir: <ref *78> ƒ rmdir(length: 3) {},
        rmdirSync: <ref *79> ƒ rmdirSync(length: 2) {},
        stat: <ref *80> ƒ stat(length: 3) {},
        statfs: <ref *81> ƒ statfs(length: 3) {},
        statSync: <ref *82> ƒ statSync(length: 1) {},
        statfsSync: <ref *83> ƒ statfsSync(length: 2) {},
        symlink: <ref *84> ƒ symlink(length: 4) {},
        symlinkSync: <ref *85> ƒ symlinkSync(length: 3) {},
        truncate: <ref *86> ƒ truncate(length: 3) {},
        truncateSync: <ref *87> ƒ truncateSync(length: 2) {},
        unlink: <ref *88> ƒ unlink(length: 2) {},
        unlinkSync: <ref *89> ƒ unlinkSync(length: 1) {},
        unwatchFile: <ref *90> ƒ unwatchFile(length: 2) {},
        utimes: <ref *91> ƒ utimes(length: 4) {},
        utimesSync: <ref *92> ƒ utimesSync(length: 3) {},
        watch: <ref *93> ƒ watch(length: 3) {},
        watchFile: <ref *94> ƒ watchFile(length: 3) {},
        write: <ref *95> ƒ write(length: 6) {},
        writeFile: <ref *96> ƒ writeFile(length: 4) {},
        writeFileSync: <ref *97> ƒ writeFileSync(length: 3) {},
        writeSync: <ref *98> ƒ writeSync(length: 5) {},
        writev: <ref *99> ƒ writev(length: 4) {},
        writevSync: <ref *100> ƒ writevSync(length: 3) {},
        _toUnixTimestamp: [Circular: *7],
        openAsBlob: <ref *101> ƒ openAsBlob(length: 2) {},
        Dirent: [Circular: *3],
        opendir: <ref *102> ƒ opendir(length: 3) {},
        opendirSync: <ref *103> ƒ opendirSync(length: 2) {},
        F_OK: 0,
    ...
    mkdtempSync: [Circular: *56],
    open: [Circular: *58],
    openAsBlob: [Circular: *101],
    openSync: [Circular: *59],
    opendir: [Circular: *102],
    opendirSync: [Circular: *103],
    promises: [Circular: *104],
    read: [Circular: *60],
    readFile: [Circular: *61],
    readFileSync: [Circular: *62],
    readSync: [Circular: *63],
    readdir: [Circular: *64],
    readdirSync: [Circular: *65],
    readlink: [Circular: *66],
    readlinkSync: [Circular: *67],
    readv: [Circular: *68],
    readvSync: [Circular: *69],
    realpath: [Circular: *70],
    realpathSync: [Circular: *72],
    rename: [Circular: *74],
    renameSync: [Circular: *75],
    rm: [Circular: *76],
    rmSync: [Circular: *77],
    rmdir: [Circular: *78],
    rmdirSync: [Circular: *79],
    stat: [Circular: *80],
    statSync: [Circular: *82],
    statfs: [Circular: *81],
    statfsSync: [Circular: *83],
    symlink: [Circular: *84],
    symlinkSync: [Circular: *85],
    truncate: [Circular: *86],
    truncateSync: [Circular: *87],
    unlink: [Circular: *88],
    unlinkSync: [Circular: *89],
    unwatchFile: [Circular: *90],
    utimes: [Circular: *91],
    utimesSync: [Circular: *92],
    watch: [Circular: *93],
    watchFile: [Circular: *94],
    write: [Circular: *95],
    writeFile: [Circular: *96],
    writeFileSync: [Circular: *97],
    writeSync: [Circular: *98],
    writev: [Circular: *99],
    writevSync: [Circular: *100]
}
```
...
[Object: null prototype] {
    ...
    default: {
        ...
        Server: [Circular: *3],
        createServer: [Circular: *4],
        get: <ref *19> ƒ get(length: 3) {},
        request: <ref *20> ƒ request(length: 0) {}
    },
    get: [Circular: *19],
    globalAgent: [Circular: *6],
    request: [Circular: *20]
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1782694153994-1/module.mjs: "/tmp/fs-fixture-1782694153994-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            ...
            "/opt/hostedtoolcache/node/24.17.0/x64/lib/node"
        ],
...
<ref *1> [Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 1) {
        _cache: <ref *3> {
            ...
            /tmp/fs-fixture-1782694153994-1/inspect.mjs: {
        ...
        enableCompileCache: <ref *27> ƒ enableCompileCache(length: 0) {},
...
[Object: null prototype] {
    ...
    PerformanceResourceTiming: <ref *9> class PerformanceResourceTiming {},
    constants: <ref *10> {
    ...
    createHistogram: <ref *11> ƒ createHistogram(length: 1) {},
    default: {
        performance: <ref *13> {
            ...
            timeOrigin: 1782694154967.6965,
            toJSON: ƒ toJSON(length: 1) {},
            onresourcetimingbufferfull: null,
            nodeTiming: PerformanceNodeTiming {
                v8Start: 1782694154967.6965,
                nodeStart: 1782694154967.6965,
                environment: 1782694154967.6965,
                bootstrapComplete: 1782694154967.6965,
                idleTime: 1,
                loopStart: 1,
                loopExit: -1
            },
        ...
        monitorEventLoopDelay: <ref *27> ƒ monitorEventLoopDelay(length: 1) {},
        createHistogram: [Circular: *11],
        PerformanceResourceTiming: [Circular: *9]
    },
    monitorEventLoopDelay: [Circular: *27],
...
[Object: null prototype] {
    ...
    argv: <ref *26> [
        ...
        "/tmp/fs-fixture-1782694153994-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        release: <ref *50> {
            name: "node",
            lts: "Krypton",
            sourceUrl: "https://nodejs.org/download/release/v24.17.0/node-v24.17.0.tar.gz",
            headersUrl: "https://nodejs.org/download/release/v24.17.0/node-v24.17.0-headers.tar.gz"
        },
        ...
        env: <ref *120>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_fd51e64a-73da-4a9f-bb78-517387eae059",
            npm_package_devDependencies__types_node: "^18.15.11",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            npm_config_user_agent: "pnpm/9.12.1 npm/? node/v24.17.0 linux x64",
            CI: "true",
            USE_BAZEL_FALLBACK_VERSION: "silent:",
            RUNNER_ENVIRONMENT: "github-hosted",
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_fd51e64a-73da-4a9f-bb78-517387eae059",
            PIPX_HOME: "/opt/pipx",
            npm_node_execpath: "/opt/hostedtoolcache/node/24.17.0/x64/bin/node",
            ...
            GITHUB_HEAD_REF: "",
            SYSTEMD_EXEC_PID: "2004",
            ACTIONS_ORCHESTRATION_ID: "d56eb337-6787-4407-b00b-6effa0763c4a.build.__default",
            ...
            GITHUB_RUN_ID: "28341846845",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "54ea96f8afc40e8429368fd3ab69d5b9d46014c2",
            ...
            RUNNER_TRACKING_ID: "github_0319b01d-8900-474d-9cd5-d07e223c82d5",
            INVOCATION_ID: "169688adfaf44395bc1a9527dd40c4a3",
            RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            NODE: "/opt/hostedtoolcache/node/24.17.0/x64/bin/node",
            GITHUB_ACTION: "__run",
            ...
            RUNNER_NAME: "GitHub Actions 1000015823",
            ...
            GITHUB_SHA: "54ea96f8afc40e8429368fd3ab69d5b9d46014c2",
            ...
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_fd51e64a-73da-4a9f-bb78-517387eae059",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_fd51e64a-73da-4a9f-bb78-517387eae059",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_fd51e64a-73da-4a9f-bb78-517387eae059",
        ...
        pid: 3101,
        ppid: 2415,
        execPath: "/opt/hostedtoolcache/node/24.17.0/x64/bin/node",
        debugPort: 9229,
        argv0: "node",
...
[Object: null prototype] {
    ...
    default: EventEmitter {
        ...
        revision: "3e8da8103f78125eb7df907a68f47061002bf7e7",
        send: undefined,
        ...
        stdin: <ref *216> ReadStream {
            ...
            _maxListeners: undefined,
            _eventsCount: NaN,
            on: <ref *227> ƒ (length: 2) {},
            addListener: [Circular: *227],
            ref: ƒ (length: 0) {},
            unref: ƒ (length: 0) {},
            pause: ƒ (length: 0) {},
            resume: ƒ (length: 0) {},
        ...
        versions: <ref *244> {
            ...
            uwebsockets: "3e8da8103f78125eb7df907a68f47061002bf7e7",
            webkit: "f72c0151d39e40bec7755bcdcd9701f3d61b8e8b",
            ...
            usockets: "3e8da8103f78125eb7df907a68f47061002bf7e7",
...
(node:3107) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
[Object: null prototype] {
    ...
    context: <ref *4> {
        ...
        queueMicrotask: ƒ queueMicrotask(length: 1) {},
        ...
        Bun: {
            ...
            Image: ƒ Image(length: 0) {
                [get/set] backend: "bun",
                clipboardChangeCount: ƒ clipboardChangeCount(length: 0) {},
                fromClipboard: ƒ fromClipboard(length: 0) {},
                hasClipboardImage: ƒ hasClipboardImage(length: 0) {}
            },
            MD4: ƒ MD4(length: 0) {
            ...
            JSONL: {
                parse: ƒ parse(length: 1) {},
                parseChunk: ƒ parseChunk(length: 1) {}
            },
            markdown: {
                html: ƒ html(length: 1) {},
                ansi: ƒ ansi(length: 2) {},
                render: ƒ render(length: 3) {},
                react: ƒ react(length: 3) {}
            },
            TOML: {
                parse: ƒ parse(length: 1) {}
            },
            ...
            gc: ƒ gc(length: 1) {},
            generateHeapSnapshot: ƒ generateHeapSnapshot(length: 2) {},
            ...
            [get/set] main: "/tmp/fs-fixture-1782694153994-1/repl.mjs",
            ...
            sql: <ref *209> ƒ sql(length: 1) {
                reserve: ƒ (length: 0) {},
                array: ƒ (length: 0) {},
                commitDistributed: ƒ (length: 0) {},
                rollbackDistributed: ƒ (length: 0) {},
                beginDistributed: <ref *214> ƒ (length: 0) {},
                distributed: [Circular: *214],
                connect: ƒ (length: 0) {},
                unsafe: ƒ (length: 0) {},
                file: ƒ (length: 1) {},
                begin: <ref *218> ƒ (length: 0) {},
                transaction: [Circular: *218],
                close: <ref *219> ƒ (length: 0) {},
                end: [Circular: *219],
                flush: ƒ (length: 0) {}
            },
            postgres: [Circular: *209],
            SQL: ƒ SQL2(length: 0) {
            ...
            sliceAnsi: ƒ sliceAnsi(length: 5) {},
            ...
            wrapAnsi: ƒ wrapAnsi(length: 3) {},
            Terminal: ƒ Terminal(length: 0) {},
            unsafe: {
                ...
                memoryFootprint: ƒ memoryFootprint(length: 1) {}
            },
            version: "1.4.0",
            WebView: ƒ WebView(length: 1) {},
        ...
        navigator: {
            [get/set] userAgent: "Bun/1.4.0",
            [get/set] platform: "Linux x86_64",
            [get/set] hardwareConcurrency: 4
        },
        performance: Performance {
            now: ƒ now(length: 0) {},
            timeOrigin: 1782694155117.7449
        },
        process: EventEmitter {
            ...
            stderr: WriteStream {
                ...
                pos: undefined,
                bytesWritten: 0,
                _write: <ref *318> ƒ underscoreWriteFast(length: 3) {},
                write: <ref *319> ƒ writeFast(length: 3) {},
                _construct: undefined,
                _events: {
                    close: undefined,
                    error: undefined,
                ...
                readable: false,
                _type: "fs",
                destroySoon: <ref *323> ƒ (length: 2) {},
                _destroy: ƒ (length: 2) {},
                _final: ƒ (length: 1) {},
                _isStdio: true,
                Symbol(kFs): <ref *326> {
                    ...
                    W_OK: 2,
                    X_OK: 1,
                    constants: <ref *423> [Object: null prototype] {
                        UV_FS_SYMLINK_DIR: 1,
                        UV_FS_SYMLINK_JUNCTION: 2,
                        O_RDONLY: 0,
                        O_WRONLY: 1,
                    ...
                    Dir: class Dir {},
                    Stats: ƒ Stats(length: 0) {},
                    [get/set] ReadStream: <ref *426> ƒ ReadStream(length: 2) {},
                    WriteStream: <ref *427> ƒ WriteStream(length: 2) {},
                    [get/set] FileReadStream: [Circular: *426],
                    [get/set] FileWriteStream: [Circular: *427],
                    promises: {
                        access: async ƒ access(length: 3) {},
                        appendFile: async ƒ appendFile(length: 1) {},
                        close: async ƒ close(length: 1) {},
            ...
            stdin: ReadStream {
                ...
                _maxListeners: undefined,
                _eventsCount: NaN,
                on: <ref *490> ƒ (length: 2) {},
                addListener: [Circular: *490],
                ref: ƒ (length: 0) {},
                unref: ƒ (length: 0) {},
                pause: ƒ (length: 0) {},
                resume: ƒ (length: 0) {},
        ...
        BuildError: <ref *530> ƒ BuildMessage(length: 0) {},
        BuildMessage: [Circular: *530],
        Crypto: ƒ Crypto(length: 0) {},
        HTMLRewriter: ƒ HTMLRewriter(length: 0) {},
        Request: ƒ Request(length: 0) {},
        ResolveError: <ref *534> ƒ ResolveMessage(length: 0) {},
        ResolveMessage: [Circular: *534],
        ...
        URLPattern: ƒ URLPattern(length: 0) {},
...
[Object: null prototype] {
    ...
    ReadableByteStreamController: <ref *6> ƒ ReadableByteStreamController(length: 3) {},
    ReadableStream: <ref *7> ƒ ReadableStream(length: 0) {},
    ReadableStreamBYOBReader: <ref *8> ƒ ReadableStreamBYOBReader(length: 1) {},
    ReadableStreamBYOBRequest: <ref *9> ƒ ReadableStreamBYOBRequest(length: 2) {},
    ReadableStreamDefaultController: <ref *10> ƒ ReadableStreamDefaultController(length: 4) {},
    ReadableStreamDefaultReader: <ref *11> ƒ ReadableStreamDefaultReader(length: 1) {},
    TextDecoderStream: <ref *12> ƒ TextDecoderStream(length: 0) {},
    TextEncoderStream: <ref *13> ƒ TextEncoderStream(length: 0) {},
    TransformStream: <ref *14> ƒ TransformStream(length: 0) {},
    TransformStreamDefaultController: <ref *15> ƒ TransformStreamDefaultController(length: 0) {},
    WritableStream: <ref *16> ƒ WritableStream(length: 0) {},
    WritableStreamDefaultController: <ref *17> ƒ WritableStreamDefaultController(length: 0) {},
    WritableStreamDefaultWriter: <ref *18> ƒ WritableStreamDefaultWriter(length: 1) {},
    default: {
        ReadableStream: [Circular: *7],
...
(node:3274) [DEP0025] DeprecationWarning: sys is deprecated. Use util instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
(node:3468) ExperimentalWarning: WASI is an experimental feature and might change at any time
...
error: Could not resolve: "node:sea". Maybe you need to "bun install"?
    at /tmp/fs-fixture-1782694153994-1/node:sea.mjs:2:25

Bun v1.4.0-canary.1+3e8da8103 (Linux x64)
```
...
error: Could not resolve: "node:sqlite". Maybe you need to "bun install"?
    at /tmp/fs-fixture-1782694153994-1/node:sqlite.mjs:2:25
...
[Object: null prototype] {
    ...
    default: <ref *30> ƒ test(length: 3) {
        ...
        mock: <ref *42> {
            fn: ƒ mockFn(length: 3) {},
            method: ƒ mockMethod(length: 4) {},
...
error: Could not resolve: "node:test/reporters". Maybe you need to "bun install"?
    at /tmp/fs-fixture-1782694153994-1/node:test_reporters.mjs:2:25
