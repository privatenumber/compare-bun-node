...
_Last updated on <!-- lastUpdated:start -->Apr 28, 2025 with Bun 1.2.11 Node.js v22.14.0<!-- lastUpdated:end -->._
...
```js
{
    ...
    abortedSymbol: Symbol(aborted),
    default: {
        ClientRequest: [Circular: *2],
        kBodyChunks: Symbol(bodyChunks),
        abortedSymbol: Symbol(aborted)
    },
    kBodyChunks: Symbol(bodyChunks)
}
...
{
    CRLF: "\r\n",
    _checkInvalidHeaderChar: <ref *2> ƒ checkInvalidHeaderChar(length: 1) {},
    _checkIsHttpToken: <ref *3> ƒ checkIsHttpToken(length: 1) {},
    chunkExpression: <ref *4> /(?:^|\W)chunked(?:$|\W)/i,
    continueExpression: <ref *5> /(?:^|\W)100-continue(?:$|\W)/i,
    default: {
        _checkIsHttpToken: [Circular: *3],
        _checkInvalidHeaderChar: [Circular: *2],
        chunkExpression: [Circular: *4],
        continueExpression: [Circular: *5],
        CRLF: "\r\n",
        methods: <ref *7> [
            "DELETE",
            "GET",
...
{
    IncomingMessage: <ref *2> ƒ IncomingMessage(length: 1) {
        prototype: <ref *3> IncomingMessage {
            constructor: [Circular: *2],
            httpVersion: "1.1",
...
```js
{
    ...
    OutgoingMessage: <ref *3> ƒ OutgoingMessage(length: 1) {
        prototype: <ref *4> OutgoingMessage {
            ...
            setTimeout: ƒ setTimeout(length: 2) {},
            [get/set] connection: <ref *22> Socket {
                _events: {
                    close: undefined,
                    error: undefined,
                    prefinish: undefined,
...
```js
{
    Server: <ref *2> ƒ Server(length: 2) {
        prototype: Server {
            ...
            setTimeout: ƒ setTimeout(length: 2) {},
            Symbol(IncomingMessage): undefined,
            Symbol(ServerResponse): undefined,
            Symbol(http.server.connectionsCheckingInterval): undefined,
            Symbol(Symbol.asyncDispose): ƒ [Symbol.asyncDispose](length: 0) {},
            Symbol(kRealListen): ƒ [kRealListen](length: 6) {}
        }
    },
    ServerResponse: <ref *14> ƒ ServerResponse(length: 2) {
        prototype: ServerResponse {
            constructor: [Circular: *14],
            _removedConnection: false,
            _removedContLen: false,
            _hasBody: true,
            _ended: false,
            [get/set] headersSent: false,
            _writeRaw: ƒ _writeRaw(length: 3) {},
            writeEarlyHints: ƒ writeEarlyHints(length: 2) {},
            writeProcessing: ƒ writeProcessing(length: 1) {},
            writeContinue: ƒ writeContinue(length: 1) {},
            end: ƒ end(length: 3) {},
            [get/set] writable: true,
            write: ƒ write(length: 3) {},
            _callPendingCallbacks: ƒ _callPendingCallbacks(length: 0) {},
            _finish: ƒ _finish(length: 0) {},
            detachSocket: ƒ detachSocket(length: 1) {},
            _implicitHeader: ƒ _implicitHeader(length: 0) {},
            [get/set] writableNeedDrain: true,
            [get/set] writableFinished: false,
            [get/set] writableLength: 16384,
            [get/set] writableHighWaterMark: 65536,
            [get/set] closed: false,
            _send: ƒ _send(length: 4) {},
            writeHead: <ref *27> ƒ writeHead(length: 3) {},
            assignSocket: ƒ assignSocket(length: 1) {},
            statusMessage: undefined,
            statusCode: 200,
            [get/set] shouldKeepAlive: true,
            [get/set] chunkedEncoding: false,
            [get/set] useChunkedEncodingByDefault: true,
            destroy: ƒ destroy(length: 1) {},
            emit: ƒ emit(length: 1) {},
            flushHeaders: ƒ flushHeaders(length: 0) {},
            writeHeader: [Circular: *27],
            Symbol(kRejectNonStandardBodyWrites): undefined
        }
    },
    default: {
        Server: [Circular: *2],
        ServerResponse: [Circular: *14],
        kConnectionsCheckingInterval: Symbol(http.server.connectionsCheckingInterval)
    },
    kConnectionsCheckingInterval: Symbol(http.server.connectionsCheckingInterval)
}
...
(node:2179) [DEP0125] DeprecationWarning: The _stream_wrap module is deprecated.
...
```js
{
    ...
    CloseEvent: <ref *5> ƒ CloseEvent(length: 1) {},
    IncomingMessage: <ref *6> ƒ IncomingMessage(length: 1) {
        prototype: <ref *7> IncomingMessage {
            constructor: [Circular: *6],
            httpVersion: "1.1",
            _construct: ƒ _construct(length: 1) {},
            _dump: ƒ _dump(length: 0) {},
            ...
            _destroy: ƒ IncomingMessage_destroy(length: 2) {},
            [get/set] aborted: undefined,
            [get/set] connection: <ref *13> Socket {
                _events: {
                    close: undefined,
                    error: undefined,
                    prefinish: undefined,
            ...
            [get/set] httpVersionMinor: 1,
            [get/set] rawTrailers: [],
            [get/set] trailers: <ref *22> [Object: null prototype] {},
            setTimeout: ƒ setTimeout(length: 2) {},
            [get/set] socket: [Circular: *13]
        }
    },
    METHODS: <ref *24> [
        "ACL",
    ...
    MessageEvent: <ref *25> ƒ MessageEvent(length: 1) {},
    OutgoingMessage: <ref *26> ƒ OutgoingMessage(length: 1) {
        prototype: <ref *27> OutgoingMessage {
            constructor: [Circular: *26],
            _keepAliveTimeout: 0,
            _defaultKeepAlive: true,
            shouldKeepAlive: true,
            _onPendingData: ƒ nop2(length: 0) {},
            ...
            setHeaders: ƒ setHeaders(length: 1) {},
            hasHeader: ƒ hasHeader(length: 1) {},
            [get/set] headers: [Circular: *22],
            addTrailers: ƒ addTrailers(length: 1) {},
            setTimeout: ƒ setTimeout(length: 2) {},
            [get/set] connection: <ref *44> Socket {
                _events: {
                    close: undefined,
                    error: undefined,
                    prefinish: undefined,
                ...
                timeout: 0,
                isServer: false,
                _httpMessage: [Circular: *27],
                _onTimeout: ƒ _onTimeout(length: 0) {},
                Symbol(kCapture): false,
                Symbol(::bunternal::): undefined
            },
            [get/set] socket: [Circular: *44],
            [get/set] chunkedEncoding: false,
            [get/set] writableObjectMode: false,
            [get/set] writableLength: 0,
            [get/set] writableHighWaterMark: 16384,
    ...
    Server: <ref *57> ƒ Server(length: 2) {
        prototype: Server {
    ...
    ServerResponse: <ref *69> ƒ ServerResponse(length: 2) {
        prototype: ServerResponse {
            ...
            [get/set] closed: false,
            _send: ƒ _send(length: 4) {},
            writeHead: <ref *82> ƒ writeHead(length: 3) {},
            assignSocket: ƒ assignSocket(length: 1) {},
            statusMessage: undefined,
            statusCode: 200,
            [get/set] shouldKeepAlive: true,
            ...
            emit: ƒ emit(length: 1) {},
            flushHeaders: ƒ flushHeaders(length: 0) {},
            writeHeader: [Circular: *82],
            Symbol(kRejectNonStandardBodyWrites): undefined
        }
    },
    WebSocket: <ref *87> ƒ WebSocket(length: 1) {
        CONNECTING: 0,
        OPEN: 1,
        CLOSING: 2,
        CLOSED: 3
    },
    createServer: <ref *88> ƒ createServer(length: 2) {},
    default: {
        Agent: [Circular: *2],
        Server: [Circular: *57],
        METHODS: [Circular: *24],
        STATUS_CODES: [Circular: *56],
        createServer: [Circular: *88],
        ServerResponse: [Circular: *69],
        IncomingMessage: [Circular: *6],
        request: <ref *90> ƒ request(length: 3) {},
        get: <ref *91> ƒ get(length: 3) {},
        [get/set] maxHeaderSize: 16384,
        validateHeaderName: <ref *92> ƒ validateHeaderName(length: 2) {},
        validateHeaderValue: <ref *93> ƒ validateHeaderValue(length: 2) {},
        setMaxIdleHTTPParsers: <ref *94> ƒ setMaxIdleHTTPParsers(length: 1) {},
        globalAgent: <ref *95> Agent {
            _events: [Object: null prototype] {},
            _eventsCount: 0,
            _maxListeners: undefined,
            defaultPort: 80,
        ...
        ClientRequest: [Circular: *3],
        OutgoingMessage: [Circular: *26],
        WebSocket: [Circular: *87],
        CloseEvent: [Circular: *5],
        MessageEvent: [Circular: *25]
    },
    get: [Circular: *91],
    globalAgent: [Circular: *95],
    maxHeaderSize: 16384,
    request: [Circular: *90],
    setMaxIdleHTTPParsers: [Circular: *94],
    validateHeaderName: [Circular: *92],
    validateHeaderValue: [Circular: *93]
}
```
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1745799505242-1/module.mjs: "/tmp/fs-fixture-1745799505242-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            ...
            "/opt/hostedtoolcache/node/22.14.0/x64/lib/node"
        ],
        ...
        stripTypeScriptTypes: <ref *29> ƒ stripTypeScriptTypes(length: 1) {},
    ...
    stripTypeScriptTypes: [Circular: *29],
...
<ref *1> {
    Module: <ref *2> ƒ Module(length: 1) {
        _cache: <ref *3> {
            ...
            /tmp/fs-fixture-1745799505242-1/module.mjs: {
                exports: {}
            },
            node:module: {
                exports: [Circular: *1]
            },
            /tmp/fs-fixture-1745799505242-1/inspect.mjs: {
                exports: {
        ...
        findSourceMap: <ref *32> ƒ findSourceMap(length: 0) {},
        ...
        register: <ref *38> ƒ register(length: 1) {},
        [get/set] runMain: <ref *39> ƒ runMain(length: 2) {},
        SourceMap: <ref *40> ƒ SourceMap(length: 1) {},
        syncBuiltinESMExports: <ref *41> ƒ syncBuiltinESMExports(length: 0) {},
        wrap: <ref *42> ƒ wrap(length: 1) {},
        [get/set] wrapper: [
    ...
    register: [Circular: *38],
    runMain: [Circular: *39],
    syncBuiltinESMExports: [Circular: *41],
    wrap: [Circular: *42],
    wrapper: [
        "(function(exports,require,module,__filename,__dirname){",
        "})"
...
```js
{
    ...
    Server: <ref *3> ƒ Server(length: 2) {},
    Socket: <ref *4> ƒ Socket(length: 1) {},
    SocketAddress: <ref *5> ƒ SocketAddress(length: 0) {},
    Stream: [Circular: *4],
...
```js
{
    ...
    createHistogram: [Unexpected Error: [object Function] (type "undefined")],
    default: {
        performance: <ref *13> {
            ...
            timeOrigin: 1745799506261.6096,
            toJSON: ƒ toJSON(length: 1) {},
            onresourcetimingbufferfull: null,
            nodeTiming: PerformanceNodeTiming {
                v8Start: 1745799506261.6096,
                nodeStart: 1745799506261.6096,
                environment: 1745799506261.6096,
                bootstrapComplete: 1745799506261.6096,
                idleTime: 1,
                loopStart: 1,
                loopExit: -1
            },
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *26> [
        "/opt/hostedtoolcache/node/22.14.0/x64/bin/node",
        "/tmp/fs-fixture-1745799505242-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        release: <ref *50> {
            name: "node",
            lts: "Jod",
            sourceUrl: "https://nodejs.org/download/release/v22.14.0/node-v22.14.0.tar.gz",
            headersUrl: "https://nodejs.org/download/release/v22.14.0/node-v22.14.0-headers.tar.gz"
        },
        ...
        ref: <ref *62> ƒ ref(length: 1) {},
        unref: <ref *63> ƒ unref(length: 1) {},
        [get/set] finalization: <ref *64> {
            register: ƒ register(length: 2) {},
            registerBeforeExit: ƒ registerBeforeExit(length: 2) {},
            unregister: ƒ unregister(length: 1) {}
        },
        hrtime: <ref *68> ƒ hrtime(length: 1) {
            bigint: ƒ hrtimeBigInt(length: 0) {}
        },
        openStdin: <ref *70> ƒ (length: 0) {},
        getuid: <ref *71> ƒ getuid(length: 0) {},
        geteuid: <ref *72> ƒ geteuid(length: 0) {},
        getgid: <ref *73> ƒ getgid(length: 0) {},
        getegid: <ref *74> ƒ getegid(length: 0) {},
        getgroups: <ref *75> ƒ getgroups(length: 0) {},
        ...
        setUncaughtExceptionCaptureCallback: <ref *77> ƒ setUncaughtExceptionCaptureCallback(length: 1) {},
        hasUncaughtExceptionCaptureCallback: <ref *78> ƒ hasUncaughtExceptionCaptureCallback(length: 0) {},
        emitWarning: <ref *79> ƒ emitWarning(length: 4) {},
        nextTick: <ref *80> ƒ nextTick(length: 1) {},
        _tickCallback: [Circular: *21],
        [get/set] sourceMapsEnabled: false,
        setSourceMapsEnabled: <ref *81> ƒ setSourceMapsEnabled(length: 1) {},
        getBuiltinModule: <ref *82> ƒ getBuiltinModule(length: 1) {},
        _debugProcess: [Circular: *3],
        _debugEnd: [Circular: *2],
        _startProfilerIdleNotifier: [Circular: *19],
        _stopProfilerIdleNotifier: [Circular: *20],
        [get/set] stdout: <ref *83> Socket {
            connecting: false,
            _hadError: false,
            _parent: null,
            _host: null,
            ...
            _events: {
                ...
                drain: undefined,
                data: undefined,
                end: <ref *85> ƒ onReadableStreamEnd(length: 0) {},
                readable: undefined
            },
            ...
            fd: 1,
            _isStdio: true,
            destroySoon: <ref *91> ƒ (length: 2) {},
            _destroy: <ref *92> ƒ dummyDestroy(length: 2) {},
            Symbol(async_id_symbol): 8,
            Symbol(kHandle): Pipe {
                Symbol(owner_symbol): [Circular: *83]
            },
        ...
        [get/set] stdin: <ref *94> Socket {
            ...
            Symbol(kHandle): Pipe {
                reading: false,
                Symbol(owner_symbol): [Circular: *94]
            },
            Symbol(lastWriteQueueSize): 0,
            Symbol(timeout): null,
            Symbol(kBuffer): null,
        ...
        [get/set] stderr: <ref *103> Socket {
            ...
            fd: 2,
            _isStdio: true,
            destroySoon: [Circular: *91],
            _destroy: [Circular: *92],
            Symbol(async_id_symbol): 10,
            Symbol(kHandle): Pipe {
                Symbol(owner_symbol): [Circular: *103]
            },
            Symbol(lastWriteQueueSize): 0,
            Symbol(timeout): null,
            Symbol(kBuffer): null,
        ...
        abort: [Circular: *22],
        umask: <ref *111> ƒ wrappedUmask(length: 1) {},
        chdir: [Circular: *30],
        cwd: [Circular: *47],
        initgroups: <ref *112> ƒ initgroups(length: 2) {},
        setgroups: <ref *113> ƒ setgroups(length: 1) {},
        setegid: <ref *114> ƒ (length: 1) {},
        seteuid: <ref *115> ƒ (length: 1) {},
        setgid: <ref *116> ƒ (length: 1) {},
        setuid: <ref *117> ƒ (length: 1) {},
        env: <ref *118>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_b88a67b6-0fee-4576-9bce-0d9fbc678904",
            npm_package_devDependencies__types_node: "^18.15.11",
            STATS_TRP: "true",
            DEPLOYMENT_BASEPATH: "/opt/runner",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            npm_config_user_agent: "pnpm/9.12.1 npm/? node/v22.14.0 linux x64",
            CI: "true",
            RUNNER_ENVIRONMENT: "github-hosted",
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_b88a67b6-0fee-4576-9bce-0d9fbc678904",
            PIPX_HOME: "/opt/pipx",
            npm_node_execpath: "/opt/hostedtoolcache/node/22.14.0/x64/bin/node",
            ...
            STATS_D: "false",
            GITHUB_RUN_ID: "14697578821",
            STATS_VMFE: "true",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "49829c0054624a7a0e8565d3cf3e6cba848ed346",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            ...
            RUNNER_TRACKING_ID: "github_0d47d8bc-a20f-4464-8124-6246efbdad27",
            INVOCATION_ID: "e89748b0d57d43b89450ef41a5c46eac",
            RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            NODE: "/opt/hostedtoolcache/node/22.14.0/x64/bin/node",
            GITHUB_ACTION: "__run",
            ...
            GITHUB_SHA: "49829c0054624a7a0e8565d3cf3e6cba848ed346",
            ...
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_b88a67b6-0fee-4576-9bce-0d9fbc678904",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_b88a67b6-0fee-4576-9bce-0d9fbc678904",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_b88a67b6-0fee-4576-9bce-0d9fbc678904",
        ...
        pid: 2865,
        ppid: 1996,
        execPath: "/opt/hostedtoolcache/node/22.14.0/x64/bin/node",
        debugPort: 9229,
        argv0: "node",
        _preload_modules: [Circular: *17],
        [get/set] report: <ref *120> {
    ...
    dlopen: [Circular: *52],
    domain: null,
    emitWarning: [Circular: *79],
    env: [Circular: *118],
    execArgv: [Circular: *119],
    execPath: "/opt/hostedtoolcache/node/22.14.0/x64/bin/node",
    exit: [Circular: *61],
    exitCode: undefined,
    features: [Circular: *76],
    finalization: [Circular: *64],
    getActiveResourcesInfo: [Circular: *54],
    getBuiltinModule: [Circular: *82],
    getegid: [Circular: *74],
    geteuid: [Circular: *72],
    getgid: [Circular: *73],
    getgroups: [Circular: *75],
    getuid: [Circular: *71],
    hasUncaughtExceptionCaptureCallback: [Circular: *78],
    hrtime: [Circular: *68],
    initgroups: [Circular: *112],
    kill: [Circular: *60],
    loadEnvFile: [Circular: *56],
    memoryUsage: [Circular: *58],
    moduleLoadList: [Circular: *51],
    nextTick: [Circular: *80],
    openStdin: [Circular: *70],
    pid: 2865,
    platform: "linux",
    ppid: 1996,
    ...
    setSourceMapsEnabled: [Circular: *81],
    setUncaughtExceptionCaptureCallback: [Circular: *77],
    setegid: [Circular: *114],
    seteuid: [Circular: *115],
    setgid: [Circular: *116],
    setgroups: [Circular: *113],
    setuid: [Circular: *117],
...
```js
{
    ...
    default: EventEmitter {
        ...
        env: <ref *31> {
            [get/set] GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_b88a67b6-0fee-4576-9bce-0d9fbc678904",
            ...
            [get/set] USER: "runner",
            [get/set] npm_config_user_agent: "pnpm/9.12.1 npm/? node/v22.14.0 linux x64",
            [get/set] CI: "true",
            [get/set] RUNNER_ENVIRONMENT: "github-hosted",
            [get/set] GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_b88a67b6-0fee-4576-9bce-0d9fbc678904",
            [get/set] PIPX_HOME: "/opt/pipx",
            [get/set] npm_node_execpath: "/opt/hostedtoolcache/node/22.14.0/x64/bin/node",
            ...
            [get/set] GRADLE_HOME: "/usr/share/gradle-8.13",
            [get/set] ANDROID_NDK_LATEST_HOME: "/usr/local/lib/android/sdk/ndk/28.1.13356709",
            ...
            [get/set] ImageVersion: "20250420.1.0",
            [get/set] RUNNER_OS: "Linux",
            [get/set] GITHUB_API_URL: "https://api.github.com",
            [get/set] GOROOT_1_22_X64: "/opt/hostedtoolcache/go/1.22.12/x64",
            ...
            [get/set] GOROOT_1_23_X64: "/opt/hostedtoolcache/go/1.23.8/x64",
            [get/set] JOURNAL_STREAM: "9:7537",
            ...
            [get/set] GITHUB_RUN_ID: "14697578821",
            [get/set] STATS_VMFE: "true",
            [get/set] GITHUB_REF_TYPE: "branch",
            [get/set] BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            [get/set] GITHUB_WORKFLOW_SHA: "49829c0054624a7a0e8565d3cf3e6cba848ed346",
            ...
            [get/set] RUNNER_TRACKING_ID: "github_0d47d8bc-a20f-4464-8124-6246efbdad27",
            [get/set] INVOCATION_ID: "e89748b0d57d43b89450ef41a5c46eac",
            [get/set] RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            [get/set] NODE: "/opt/hostedtoolcache/node/22.14.0/x64/bin/node",
            [get/set] GITHUB_ACTION: "__run",
            [get/set] GITHUB_RUN_NUMBER: "127",
            ...
            [get/set] RUNNER_NAME: "GitHub Actions 1000001302",
            ...
            [get/set] GITHUB_SHA: "49829c0054624a7a0e8565d3cf3e6cba848ed346",
            ...
            [get/set] GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_b88a67b6-0fee-4576-9bce-0d9fbc678904",
            ...
            [get/set] GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_b88a67b6-0fee-4576-9bce-0d9fbc678904",
            ...
            [get/set] GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_b88a67b6-0fee-4576-9bce-0d9fbc678904",
            [get/set] INIT_CWD: "/home/runner/work/compare-bun-node/compare-bun-node"
        },
        [get/set] execArgv: <ref *32> [],
        ...
        nextTick: <ref *43> ƒ nextTick(length: 1) {},
        ...
        ref: <ref *46> ƒ ref(length: 1) {},
        release: <ref *47> {
            name: "node",
            sourceUrl: "https://github.com/oven-sh/bun/releases/download/bun-v1.2.11/bun-linux-x64-baseline.zip",
        ...
        revision: "1ee7bab0e760502e536d7f78ea3780acb5828cc0",
        setSourceMapsEnabled: <ref *51> ƒ setSourceMapsEnabled(length: 1) {},
        setUncaughtExceptionCaptureCallback: <ref *52> ƒ setUncaughtExceptionCaptureCallback(length: 1) {},
        send: undefined,
        stderr: <ref *53> WriteStream {
            fd: 2,
            _writev: undefined,
            flush: false,
            start: undefined,
            pos: undefined,
            bytesWritten: 0,
            _write: <ref *54> ƒ underscoreWriteFast(length: 3) {},
            write: <ref *55> ƒ writeFast(length: 3) {},
            _events: {
                close: undefined,
                error: undefined,
                prefinish: undefined,
            ...
            Symbol(kFs): <ref *61> {
                ...
                W_OK: 2,
                X_OK: 1,
                constants: <ref *157> [Object: null prototype] {
                    UV_FS_SYMLINK_DIR: 1,
                    UV_FS_SYMLINK_JUNCTION: 2,
                    O_RDONLY: 0,
                    O_WRONLY: 1,
                ...
                ReadStream: <ref *160> ƒ ReadStream(length: 2) {},
                WriteStream: <ref *161> ƒ WriteStream(length: 2) {},
                [get/set] FileReadStream: [Circular: *160],
                [get/set] FileWriteStream: [Circular: *161],
                promises: {
                    access: async ƒ access(length: 3) {},
                    appendFile: async ƒ appendFile(length: 1) {},
                    close: async ƒ close(length: 1) {},
        ...
        stdin: <ref *208> ReadStream {
            ...
            _maxListeners: undefined,
            _eventsCount: NaN,
            on: <ref *219> ƒ (length: 2) {},
            addListener: [Circular: *219],
            ref: ƒ (length: 0) {},
            unref: ƒ (length: 0) {},
            pause: ƒ (length: 0) {},
            resume: ƒ (length: 0) {},
            _read: ƒ triggerRead(length: 1) {},
            Symbol(kFs): [Circular: *61],
            Symbol(kReadStreamFastPath): false,
            Symbol(kCapture): false
        },
        stdout: <ref *225> WriteStream {
            fd: 1,
            _writev: undefined,
            flush: false,
            start: undefined,
        ...
        [get/set] title: "bun",
        umask: <ref *231> ƒ umask(length: 1) {},
        unref: <ref *232> ƒ unref(length: 1) {},
        uptime: <ref *233> ƒ uptime(length: 1) {},
        version: "v22.6.0",
        versions: <ref *234> {
            node: "22.6.0",
            bun: "1.2.11",
            ...
            uwebsockets: "1ee7bab0e760502e536d7f78ea3780acb5828cc0",
            webkit: "11b10bb50bd69481fe4c7a4dd075eea4755b3fee",
            zig: "0.14.0",
            ...
            usockets: "1ee7bab0e760502e536d7f78ea3780acb5828cc0",
        ...
        _kill: [Circular: *7],
        getBuiltinModule: <ref *235> ƒ getBuiltinModule(length: 1) {},
        getegid: <ref *236> ƒ getegid(length: 0) {},
        geteuid: <ref *237> ƒ geteuid(length: 0) {},
        getgid: <ref *238> ƒ getgid(length: 0) {},
        getgroups: <ref *239> ƒ getgroups(length: 0) {},
        getuid: <ref *240> ƒ getuid(length: 0) {},
        setegid: <ref *241> ƒ setegid(length: 1) {},
        seteuid: <ref *242> ƒ seteuid(length: 1) {},
        setgid: <ref *243> ƒ setgid(length: 1) {},
        setgroups: <ref *244> ƒ setgroups(length: 1) {},
        setuid: <ref *245> ƒ setuid(length: 1) {},
    ...
    getBuiltinModule: [Circular: *235],
    getMaxListeners: ƒ getMaxListeners(length: 0) {},
    getegid: [Circular: *236],
    geteuid: [Circular: *237],
    getgid: [Circular: *238],
    getgroups: [Circular: *239],
    getuid: [Circular: *240],
    ...
    send: undefined,
    setMaxListeners: ƒ setMaxListeners(length: 1) {},
    setSourceMapsEnabled: [Circular: *51],
    setUncaughtExceptionCaptureCallback: [Circular: *52],
    setegid: [Circular: *241],
    seteuid: [Circular: *242],
    setgid: [Circular: *243],
    setgroups: [Circular: *244],
    setuid: [Circular: *245],
    stderr: [Circular: *53],
    stdin: [Circular: *208],
    stdout: [Circular: *225],
...
```js
{
    ...
    context: <ref *4> {
        ...
        Bun: {
            ...
            argv: <ref *102> [
                "/home/runner/.bun/bin/bun",
                "/tmp/fs-fixture-1745799505242-1/repl.mjs"
            ],
            ...
            main: "/tmp/fs-fixture-1745799505242-1/repl.mjs",
            ...
            sql: <ref *182> ƒ sql(length: 1) {
                reserve: ƒ (length: 0) {},
                commitDistributed: ƒ (length: 0) {},
                rollbackDistributed: ƒ (length: 0) {},
                beginDistributed: <ref *186> ƒ (length: 0) {},
                distributed: [Circular: *186],
                connect: ƒ (length: 0) {},
                unsafe: ƒ (length: 0) {},
                file: ƒ (length: 1) {},
                begin: <ref *190> ƒ (length: 0) {},
                transaction: [Circular: *190],
                close: <ref *191> ƒ (length: 0) {},
                end: [Circular: *191],
                flush: ƒ (length: 0) {}
            },
            postgres: [Circular: *182],
            SQL: ƒ SQL(length: 1) {},
        ...
        navigator: {
            userAgent: "Bun/1.2.11",
            platform: "Linux x86_64",
            hardwareConcurrency: 4
        },
        performance: Performance {
            now: ƒ now(length: 0) {},
            timeOrigin: 1745799506374.0798
        },
        process: EventEmitter {
            abort: ƒ abort(length: 1) {},
            allowedNodeEnvironmentFlags: Set {},
            arch: "x64",
            [get/set] argv: [Circular: *102],
            argv0: "bun",
            assert: ƒ assert(length: 1) {},
            ...
            stderr: WriteStream {
                ...
                pos: undefined,
                bytesWritten: 0,
                _write: <ref *256> ƒ underscoreWriteFast(length: 3) {},
                write: <ref *257> ƒ writeFast(length: 3) {},
                _events: {
                    close: undefined,
                    error: undefined,
                    prefinish: undefined,
                ...
                readable: false,
                _type: "fs",
                destroySoon: <ref *264> ƒ (length: 2) {},
                _destroy: ƒ (length: 2) {},
                _isStdio: true,
                Symbol(kFs): <ref *266> {
                    appendFile: ƒ appendFile(length: 4) {},
                    ...
                    W_OK: 2,
                    X_OK: 1,
                    constants: <ref *362> [Object: null prototype] {
                        UV_FS_SYMLINK_DIR: 1,
                        UV_FS_SYMLINK_JUNCTION: 2,
                        O_RDONLY: 0,
                        O_WRONLY: 1,
                    ...
                    Dir: class Dir {},
                    Stats: ƒ Stats(length: 0) {},
                    [get/set] ReadStream: <ref *365> ƒ ReadStream(length: 2) {},
                    WriteStream: <ref *366> ƒ WriteStream(length: 2) {},
                    [get/set] FileReadStream: [Circular: *365],
                    [get/set] FileWriteStream: [Circular: *366],
                    promises: {
                        access: async ƒ access(length: 3) {},
                        appendFile: async ƒ appendFile(length: 1) {},
                        close: async ƒ close(length: 1) {},
            ...
            stdin: ReadStream {
                ...
                _maxListeners: undefined,
                _eventsCount: NaN,
                on: <ref *427> ƒ (length: 2) {},
                addListener: [Circular: *427],
                ref: ƒ (length: 0) {},
                unref: ƒ (length: 0) {},
                pause: ƒ (length: 0) {},
                resume: ƒ (length: 0) {},
                _read: ƒ triggerRead(length: 1) {},
                Symbol(kFs): [Circular: *266],
                Symbol(kReadStreamFastPath): false,
                Symbol(kCapture): false
            },
            stdout: WriteStream {
        ...
        BuildError: <ref *481> ƒ BuildMessage(length: 0) {},
        BuildMessage: [Circular: *481],
        Crypto: ƒ Crypto(length: 0) {},
        HTMLRewriter: ƒ HTMLRewriter(length: 0) {},
        Request: ƒ Request(length: 0) {},
        ResolveError: <ref *485> ƒ ResolveMessage(length: 0) {},
        ResolveMessage: [Circular: *485],
...
(node:3085) [DEP0025] DeprecationWarning: sys is deprecated. Use util instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
```
...
(node:3316) ExperimentalWarning: WASI is an experimental feature and might change at any time
